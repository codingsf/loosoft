...
namespace sungrow_demo.Service
{
    class LogUtil
    {
        ...
        public static void debug(string msg) {
            msg = "[debug]sungrow_demo_" + DateTime.Now.ToString("MMdd hh:mm:ss") + "__" + msg;
        ...
        {
            msg = "[info]sungrow_demo_" + DateTime.Now.ToString("MMdd hh:mm:ss") + "__" + msg;
        ...
        {
            msg = "[warn]sungrow_demo_" + DateTime.Now.ToString("MMdd hh:mm:ss") + "__" + msg;
        ...
        {
            msg = "[error]sungrow_demo_" + DateTime.Now.ToString("MMdd hh:mm:ss") + "__" + msg;
