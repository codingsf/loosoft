...
namespace Protocol
{
    ...
    /// 汇流箱装置
    /// </summary>
    public class SungrowBusbar : DeviceDataBase
    {
        ...
        public void analysis()
        {
            ...
            //第一路电流 0.1A
            double current1 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(0 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第二路电流
            double current2 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(1 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //三路电流
            double current3 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(2 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第四路电流
            double current4 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(3 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第五路电流
            double current5 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(4 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第六路电流
            double current6 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(5 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第七路电流
            double current7 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(6 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第八路电流
            double current8 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(7 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第九路电流
            double current9 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(8 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十路电流
            double current10 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(9 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十路电流
            double current11 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(10 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十二路电流
            double current12 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(11 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十三路电流
            double current13 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(12 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十四路电流
            double current14 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(13 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十五路电流
            double current15 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(14 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //第十六路电流
            double current16 = (double)SystemCode.HexNumberToDenary(monitorstr.Substring(15 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            ...
            //阵列电压
            int ZLVOILT = (int)SystemCode.HexNumberToDenary(monitorstr.Substring(17 * hexbytecharnum, 2 * hexbytecharnum), true, 16, 'u');
            current3 = Math.Round(current3 * 0.1, 1);
            ...
            //接入传感器路数
            int CGQLINENUM = (int)SystemCode.HexNumberToDenary(monitorstr.Substring(21 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
            realMonitorMap[MonitorType.MIC_BUSBAR_CGQLINENUM] =CGQLINENUM;
            //通讯类型
            int COMMUNICATION = (int)SystemCode.HexNumberToDenary(monitorstr.Substring(22 * hexbytecharnum, 1 * hexbytecharnum), true, 8, 'u');
        ...
        public SungrowBusbar(string tcpcontent, BaseMessage message)
        {
