...
namespace Cn.Loosoft.Zhisou.SunPower.Common
{
    ...
    public static class AuthorizationCode
    {
        ...
        static AuthorizationCode()
        {
            ...
            //编辑电站
            controllerActionRoles.Add(EDIT_PLANT, new ControllerAction() { displayName = "编辑电站", controller = "plant", action = "edit", typeId = 1 });
            //删除电站
            controllerActionRoles.Add(DELETE_PLANT, new ControllerAction() { displayName = "删除电站", controller = "user", action = "delete", typeId = 1 });
            //电站列表
            controllerActionRoles.Add(PLANTS_LIST, new ControllerAction() { displayName = "电站列表", controller = "plant", action = "allplants", typeId = 1 });
            //电站资料
            controllerActionRoles.Add(PLANT_PROFILE, new ControllerAction() { displayName = "电站资料", controller = "plant", action = "overview", typeId = 1 });
            //所有电站概览
            ...
            //单个电站概览
            controllerActionRoles.Add(PLANT_OVERVIEW, new ControllerAction() { displayName = "单个电站概览", controller = "plant", action = "overview", typeId = 1 });
            //单元列表
            controllerActionRoles.Add(UNIT_LIST, new ControllerAction() { displayName = "单元列表", controller = "unit", action = "list", typeId = 2 });
            //添加单元
            controllerActionRoles.Add(ADD_UNIT, new ControllerAction() { displayName = "添加单元", controller = "unit", action = "bind", typeId = 2 });
            //编辑单元
            controllerActionRoles.Add(EDIT_UNIT, new ControllerAction() { displayName = "编辑单元", controller = "unit", action = "edit", typeId = 2 });
            //删除单元
            controllerActionRoles.Add(DELETE_UNIT, new ControllerAction() { displayName = "删除单元", controller = "unit", action = "deleteunit", typeId = 2 });
            //电站地图
            controllerActionRoles.Add(PLANT_MAP, new ControllerAction() { displayName = "电站地图", controller = "plant", action = "map", typeId = 3 });
            //编辑电站地图
            ...
            //电站视频监控
            controllerActionRoles.Add(PLANT_MONITOR, new ControllerAction() { displayName = "电站视频监控", controller = "plant", action = "monitor", typeId = 4 });
            //添加视频监控
            controllerActionRoles.Add(ADD_MONITOR, new ControllerAction() { displayName = "添加视频监控", controller = "plant", action = "monitor_add", typeId = 4 });
            //删除视频监控
            controllerActionRoles.Add(DELETE_MONITOR, new ControllerAction() { displayName = "删除视频监控", controller = "plant", action = "monitor_delete", typeId = 4 });
            //设备列表
            controllerActionRoles.Add(DEVICE_LIST, new ControllerAction() { displayName = "设备列表", controller = "plant", action = "devicemonitor", typeId = 5 });
            //编辑设备监控
            controllerActionRoles.Add(EDIT_DEVICE, new ControllerAction() { displayName = "编辑设备监控", controller = "plant", action = "modifydevicemonitor", typeId = 5 });
            //日志列表
            controllerActionRoles.Add(LOGS_LIST, new ControllerAction() { displayName = "日志列表", controller = "plant", action = "log", typeId = 6 });
            //日志确认
            controllerActionRoles.Add(LOGS_CONFIRM, new ControllerAction() { displayName = "日志确认", controller = "plant", action = "logconfirm", typeId = 6 });
            //年发电量比较
            controllerActionRoles.Add(YEAR_ENERGY_COMPARE, new ControllerAction() { displayName = "年发电量比较", controller = "user", action = "EnergyYearCompare", typeId = 7 });
            //投资收益比较
            controllerActionRoles.Add(TOUZISHOUYI_COMPARE, new ControllerAction() { displayName = "投资收益比较", controller = "user", action = "PEnergyCompare", typeId = 7 });
            //添加电站
            ...
            //日比较
            controllerActionRoles.Add(DAY_COMPARE, new ControllerAction() { displayName = "日比较", controller = "plantchart", action = "daycompare", typeId = 7 });
            //多发电量比较
            ...
            //投资收益
            controllerActionRoles.Add(TOUZISHOUYI, new ControllerAction() { displayName = "投资收益", controller = "plantchart", action = "PlantDayPEnergyPage", typeId = 7 });
            //自定义图表
            controllerActionRoles.Add(DEFINED_CHART, new ControllerAction() { displayName = "自定义图表", controller = "user", action = "customchart", typeId = 11 });
            //报告列表
            ...
            //报表设置
            controllerActionRoles.Add(REPORT_CONFIG, new ControllerAction() { displayName = "报表设置", controller = "user", action = "AllPlantsReport", typeId = 9 });
            //删除报告
            ...
            //事件报告
            controllerActionRoles.Add(EVENT_REPORT, new ControllerAction() { displayName = "事件报告", controller = "Reports", action = "EventReport", typeId = 10 });
            //创建图表
