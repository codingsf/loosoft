    ...
    <table width="705" border="0" align="center" cellpadding="0" cellspacing="0" class="mt15">
        <tr>
            <td height="34" background="/images/lc/lcbg03.jpg">
                <div class="lcintt01">
                    <span class="f1 ml15 red">注：* 为必填项</span> <span class="fr mr15 mt10"><a href="#">
                        <img src="/images/lc/lc_del.gif" width="14" height="13" border="0" /></a></span>
                </div>
            </td>
        </tr>
        <tr>
            <td background="/images/lc/lcbg04.jpg">
                <div class="lcin01 mt10">
                    <ul>
                        <li>名称
                            <input class="lcinput02" id="name" name="name" value="" type="text">
                            <span class="redzi">*</span> </li>
                        <li>设计功率
                            <input name="design_power" type="text" class="lcinput01" />
                            <span class="redzi">* </span>kWp </li>
                        <li>时区
                            <%=Html.DropDownList("timezone", Cn.Loosoft.Zhisou.SunPower.Common.TimeZone.Data, new { @class = "subselect01 iv lcinput02" })%>
                        </li>
                    </ul>
                </div>
            </td>
                ...
                <table width="684" border="0" align="center" cellpadding="0" cellspacing="0" class="mt10">
                    ...
                    <tr>
                        <td background="/images/lc/lcbg07.jpg">
                            <div class="ss_zk0">
                                <span class="ss_zkico"><a href="javascript:void(0)" id="change" class="sza">收起选填项</a></span>
                            </div>
                        </td>
                    </tr>
                    <tr id="unessential">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tlist">
                                <tr>
                                    ...
                                    <td rowspan="8" valign="top">
                                        <span class="sc01"><strong>添加图片：</strong>
                                            <input name="textfield322222" type="text" class="lcinput02" />
                                            <input type="submit" name="Submit32" value="上传" class="sc_btu" />
                                        </span><span class="sc02">提示：添加您的电站图片！</span>
                                        <div class="scbox">
                                            <img src="/images/sub/img05.gif" width="115" height="75" />
                                            <span><a href="#" class="dbl">大图</a> | <a href="#" class="dbl">删除</a> </span>
                                        </div>
                                        <div class="scbox">
                                            <img src="/images/sub/img05.gif" width="115" height="75" /><span> <a href="#" class="dbl">
                                                大图</a> | <a href="#" class="dbl">删除</a> </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
