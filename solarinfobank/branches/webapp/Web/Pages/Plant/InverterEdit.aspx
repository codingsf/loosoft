            ...
            <div class="sb_mid">
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="96%">
                ...
                <tr>
                  ...
                  <td class="pr_10" height="35"><strong><%=Resources.SunResource.PLANT_DEVICEMONITOR_CURRENT_POWER%>:</strong></td>
                  <td>
                  
                       <%=device.runData.isFault() ? 0 : device.getMonitorValue(MonitorType.MIC_INVERTER_TOTALYGPOWER)%>
                       </td>
                  </tr>
                
                  <tr>

                  <td class="pr_10" height="35"><strong><%=Resources.SunResource.PLANT_DEVICEMONITOR_DEVICE_STATUS%>:</strong></td>
                  <td>
                <%=device.runData.getMonitorValue(MonitorType.MIC_INVERTER_DEVICESTATUS)%>
                </td>
                  </tr>
                  <tr>

                  <td class="pr_10" height="35"><strong><%=Resources.SunResource.PLANT_OVERVIEW_TODAY_ENERGRY%>:</strong></td>
                  <td>
                  
                  <%=device.TodayEnergy(Model.timezone)%></td>
                  </tr>
                   <tr>
