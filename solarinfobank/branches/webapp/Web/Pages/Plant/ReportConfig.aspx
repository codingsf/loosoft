...
<script>
   ...
   <td width="793" valign="top" background="/images/kj/kjbg01.jpg">
    <table width="100%" height="63" border="0" cellpadding="0" cellspacing="0" background="/images/kj/kjbg02.jpg">
        ...
        <div class="subrbox01">
                            <% using (Html.BeginForm("ReportSaves", "plant", FormMethod.Post, new { @id = "editForm", name = "editForm" }))
                       {%>
            
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                <tr>
                    <td width="39%" valign="top">
                    <%=Html.Hidden("plants",(Model as Plant).id) %>
        ...
        <div>
            <table width="350" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <%}
                      ...
                      {
                          if (Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().plants.Count <= 0)
                          {
                          %>
                            <input name="Submit" type="button" class="txtbu06" value="<%=Resources.SunResource.MONITORITEM_SUBMIT%>" />
                        <%}
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="down_line01">
                                <tr>
                                    <td width="25%" height="42" align="center">
                                        <a href="/plant/overview/<%=item.plants[0].id %>" class="green"><%=item.plants[0].name %></a>
                                    </td>
                                    <td width="17%" align="center">
                                            <%=item.type%>
                                    </td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitleContent" runat="server">
    <%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().organize %> <%=Model.name %>  <%=Resources.SunResource.USER_REPORTCONFIG_REPORT_CONFIGURATION%> </asp:Content>
