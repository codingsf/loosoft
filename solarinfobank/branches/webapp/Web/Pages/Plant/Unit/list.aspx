                    ...
                    <tr>
                      ...
                      {%>
                        ...
                        <td width="94%">
                            ...
                            <a href="/unit/units_output/<%=Model.id %>" class="dbl"><%=Resources.SunResource.DEVICE_MONITOR_EXPORT_CSV%></a>
                            ...
                            <table class="down_line0<%= i%2 %>" border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <td align="center" width="15%">
                                    ...
                                    <%} else{%>
                                            ...
                                            <img src="/images/sub/pencil0.gif" width="16" height="16" border="0" alt="<%=Resources.SunResource.MONITORITEM_EDIT%>" title="<%=Resources.SunResource.MONITORITEM_EDIT%>" /> 
                                    ...
                                    <%} else{%>
                                            <img src="/images/sub/cross00.gif" width="16"
