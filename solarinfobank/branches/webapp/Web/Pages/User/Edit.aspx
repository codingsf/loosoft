...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  SUNGROW  <%=Resources.SunResource.SHARED_INSIDEMASTERPAGE_USER_INFORMATION  %>
    </asp:Content>
            ...
            <div class="sb_mid">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <%= Html.TextBoxFor(model => model.email, new { @class = "txtbu01", @onmousedown =                            
                            "clearMessage()"})%> <span class="red">*</span  
                        </td>
                        <td>
...
<%--  <%=Html.DropDownList("currencies", Currencies.CurrentList, new { @class = "txtbu01", style = "width: 181px; height: 23px; line-height:23px;float:left;" })%>--%>
  <input type="hidden" value="<%=this.Model.currencies %>" />
    <select class="txtbu01" id="currencies" name="currencies" style="width: 181px; height: 23px; line-height: 23px; float: left;">
  ...
  <span class="red" style="line-height:23px; margin-left:2PX; height:23px; text-align:left; float:left; text-indent:2px; ">*</span>
                        </td>
                        <td class="redzi">
        ...
        <div class="subrbox01">
            <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="f_14">
                        <strong><%=Resources.SunResource.USER_EDIT_OPTIONAL %></strong>
                    </td>
                </tr>
            </table>
            <div class="sb_top">
            ...
            <table width="350" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        ...
                        <input name="Submit2" type="reset" class="txtbu03"
                            value="<%=Resources.SunResource.MONITORITEM_RESET %>" />
                    </td>
                </tr>
            </table>
        </div>
