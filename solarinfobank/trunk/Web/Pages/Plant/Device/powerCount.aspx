...
<table width="100%" border="1"  bordercolor="#A8A8A8" cellpadding="0" cellspacing="0" style="color:#525252; border-collapse :collapse;">
    ...
    <tr>
      ...
      <td class="line_b"align="center"><%=ViewData["dayddc"] == null ? "" : (ViewData["dayddc"] as DeviceDataCount).maxValue.ToString()%> W</td>
    ...
    <tr>
      ...
      <td class="line_b"align="center"><%=ViewData["monthddc"] == null ? "" : (ViewData["monthddc"] as DeviceDataCount).maxValue.ToString()%> W</td>
    ...
    <tr>
      ...
      <td class="line_b" align="center"><%=ViewData["yearddc"] == null ? "" : (ViewData["yearddc"] as DeviceDataCount).maxValue.ToString()%> W</td>
