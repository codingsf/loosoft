...
<script type="text/javascript">
        ...
        function dayCompareChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantChart/CompareDaykWpChartByPlant",
                data: { pId: <%=Model.id%>, startYYYYMMDDHH: $("#startYYYYMMDDHH").val(), endYYYYMMDDHH: $("#endYYYYMMDDHH").val(), chartType: $("#chartType").val(), intervalMins: $("#intervalMins").val() },
        ...
        function monthCompareChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantChart/CompareMonthkWpChartByPlant",
                data: { pId: <%=Model.id%>, startYYYYMMDD: $("#startYYYYMMDD").val(), endYYYYMMDD: $("#endYYYYMMDD").val(), chartType: $("#chartType").val() },
                success: function(result) {
                    if (appendChartError(curContainer, result, ajaxImgTop)) {
                        $("#monthdatadiv").html($("#monthdatadiv_html").html());
                        $("#chart_tip").hide();
       ...
       function yearCompareChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantChart/CompareYearkWpChartByPlant",
                data: { pId: <%=Model.id%>, startYYYYMM: $("#year").val()+'01', endYYYYMM: $("#year").val()+'12', chartType: $("#chartType").val() },
                success: function(result) {
                    if (appendChartError(curContainer, result, ajaxImgTop)) {
                        $("#yeardatadiv").html($("#yeardatadiv_html").html());
                        $("#chart_tip").hiden();
...
<input type="hidden" value="<%=DateTime.Now.Year+DateTime.Now.Month.ToString("00")+DateTime.Now.Day.ToString("00")%>"
    id="YYYYMMDD" />
<input type="hidden" value="<%=DateTime.Now.Year+DateTime.Now.Month.ToString("00")+(DateTime.Now.Day).ToString("00") %>06"
    id="startYYYYMMDDHH" />
<input type="hidden" value="<%=DateTime.Now.Year+DateTime.Now.Month.ToString("00")+(DateTime.Now.Day).ToString("00") %>20"
    id="endYYYYMMDDHH" />
        ...
        <td width="777">
            <table width="98%" height="45" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="pv0216">
                        <%=Resources.SunResource.CHART_UNITCOMPARE_CHART%>
                    </td>
    ...
    <div class="sb_mid">
        ...
        <div style="padding: 20px 0px; width: 730px; overflow: auto;" id="countDataDiv">
            ...
            <div id="daydatadiv_html" style="display: none;">
                ...
                <tr >
                    <td colspan="10" width="8%" height="25" style="border:none">
                        <%=Resources.SunResource.UNITINVEST_INCOME_COMPARE_CHART_TWO%>
                    </td>
                </tr>
                </table>
                            ...
                            <div class="out">
                                <b>
                                    <%=Resources.SunResource.CUSTOMREPORT_TIME %></b> <em>
                                        <%=Resources.SunResource.COMPARE_UNIT_ITEM %></em>
                            </div>
                        </td>
            ...
            <!--
               ...
               <td colspan="10" width="8%" style="border:none; border-bottom:solid 1px #A8A8A8 " height="25">
               <%=Resources.SunResource.UNITINVEST_INCOME_COMPARE_CHART_TWO%>
               </td>
               </tr>
               </table>
                    ...
                    <tbody>
                        <tr>
                          <td width="8%" height="24" bgcolor="#F2F4E1" class="line_b">
                            ...
                            <em><%=Resources.SunResource.COMPARE_UNIT_ITEM %></em>
                            </div>
                          </td>
            ...
            <div id="yeardatadiv_html" style="display: none;">
                ...
                <tr style="border:solid 1px #fff;border-bottom:solid 1px #A8A8A8;">
                    <td colspan="10" width="8%"  height="25" style="border:none">
                        <%=Resources.SunResource.UNITINVEST_INCOME_COMPARE_CHART_TWO%>
                    </td>
                </tr>
...
<script>    document.title = '<%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().organize %> <%=Model.name %> <%=Resources.SunResource.SHARED_INSIDEMASTERPAGE_UNIT_COMPARED_CHART %>'</script>
