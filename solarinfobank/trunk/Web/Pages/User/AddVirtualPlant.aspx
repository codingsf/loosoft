...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	If you are using your own debug handler or when you deploy to production and
                        ...
                        $("#btnSave").click(function() {
                            if (checkform()) {
                                $.ajax({
                                    ...
                                    data: { pids: getcheckboxes('plant', 'ref'),
                                        ptypes: getcheckboxes('plant', 'ptype'),
                ...
                <div class="subrbox01">
                    ...
                    <div class="bitab">
                        <ul id="bitab">
                            <li><a href="/user/addplant">新电站 </a></li>
                            <li></li>
                            <li><a href="#" class="onclick">组合电站 </a></li>
                        </ul>
                    </div>
                    <div class="sb_mid">
                        <table width="100%" cellpadding="0" cellspacing="0" style="line-height: 24px;">
                            ...
                            <tr>
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <select id="s2" class="txtbu01" name="s2" style="width: 181px; height: 23px; float: left;">
                                        <option>
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div id="spanButtonPlaceholder" style="margin-top: 10px; line-height: 22px;">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div id="spanButtonPlaceholder1" style="margin-top: 10px; line-height: 22px;">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" id="sutpic" />
                                    <input type="hidden" id="pic" />
                                </td>
                            </tr>
                            <tr>
                                <td height="120" align="right" valign="top" style="padding-right: 5px;">
                                    说明：
                                </td>
                                <td style="padding-left: 5px;">
                                    <textarea name="descr" id="descr" class="txtbu05" style="width: 300px;"></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <%int i = 0;
                                              foreach (Plant plant in Model.createToplevelPlants)
                                              {
                                            ...
                                            <td width="33%" style="padding-left: 5px;">
                                                <strong>
                                                    <input type="checkbox" name="plant" value="checkbox" ref="<%=plant.id%>" ptype="<%=plant.isVirtualPlant%>" />
                                                </strong>
                                                <%=plant.name%>
                                            </td>
                                            <%} %>
