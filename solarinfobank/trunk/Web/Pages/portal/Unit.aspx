...
<head>
    ...
    var exportButtonTitle = "<%=Resources.SunResource.EXPORTBUTTONTITLE %>"
                ...
                function changeChartTab(type)
                {
                if(type==1){
               window.location.reload(true);
            }else {
                loadContent('chart_container','/portal/hlxchart/?uid=<%=Request["uid"] %>&pid=<%=Request["pid"] %>','ajax','GET');
            }
                }
        ...
        <div class="gf_boxb">
            ...
            <div id="chart_container">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="9" height="9" style="background: url(/images/gf/tci/tc01.gif) bottom repeat-x;">
                        </td>
                        <td style="background: url(/images/gf/tci/tc02.gif) bottom repeat-x;">
                         <%if (bool.Parse(ViewData["hashlx"].ToString()))
                           { %>
                            <div class="bitab0">
                                <ul id="bitab0">
                                    <li><a href="javascript:void(0);" onclick="changeChartTab(1);" class="onclick">
                                        <%=Resources.SunResource.DEVICETYPE_1%></a></li>
                                    <li><a href="javascript:void(0);" onclick="changeChartTab(2);">
                                        <%=Resources.SunResource.DEVICETYPE_3%></a></li>
                                </ul>
                            </div>
                            <%} %>
                        </td>
                        <td width="9" height="9" style="background: url(/images/gf/tci/tc03.gif) bottom repeat-x;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            ...
                            <div>
                                ...
                                <!-- count data-->
                                <!-- count data-->
                                <div style="padding: 20px 0px; width: 1000px; overflow: auto;" id="countDataDiv">
                                    <div id="daydatadiv">
                                    </div>
                                        ...
                                        <table border="1" bordercolor="#A8A8A8" cellpadding="0" cellspacing="0" style="color: #525252;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;2&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center" id="col28">
                                                        &nbsp;&nbsp;&nbsp;28&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center" id="col29">
                                                        &nbsp;&nbsp;&nbsp;29&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center" id="col30">
                                                        &nbsp;&nbsp;&nbsp;30&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                    <td width="3%" height="24" bgcolor="#F2F4E1" class="line_b" align="center" id="col31">
                                                        &nbsp;&nbsp;&nbsp;31&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                            </tbody>
