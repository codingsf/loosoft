...
ECOTree.prototype.toString = function () {	
	...
	{
		case "CANVAS":
			s.push('<canvas id="ECOTreecanvas" width=1000 height=2000></canvas>');
			break;
		...
		case "HTML":
			...
			s.push('<v:group coordsize="2000, 2000" coordorigin="0, 0" style="position:absolute;width=2000px;height=2000px;" >');
			s.push(this._drawTree());
			s.push('</v:group>');
			break;
	}
