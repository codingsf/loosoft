        ...
        public void Processing()
        {
            ...
            while (1 == 1)
            {
                ...
                if (TcpMessagePool.IsNull())
                {
                    ...
                    //string tcptest = "68 68 64 00 31 31 30 38 30 31 30 30 32 00 00 00 00 00 00 00 00 0C 04 03 0E 32 0B 00 00 00 00 00 00 00 00 9C B0 01 00 01 00 3C ED 21 00 00 ED 03 00 00 1D E5 00 12 04 A5 00 03 00 00 02 D1 00 00 00 2E 00 00 00 17 01 CF 00 EC 00 05 00 00 06 0B 06 2C 29 7C 1F 40 00 00 00 04 00 29 00 00 00 00 00 00 49 0C 88 0D";
