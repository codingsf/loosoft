...
namespace Cn.Loosoft.Zhisou.SunPower.Common
{
    ...
    public class DeviceData
    {
        ...
        /// <summary>
        /// 0x42 阳光电表通信协议V1.1 add by qhb in 20120514
        /// </summary>
        public const int TYPE_AMMETER_11 = 0x42;
        ...
        static DeviceData()
        {
            ...
            protocolTypeMap.Add(TYPE_AMMETER_11, new ProtocolType() { code = TYPE_AMMETER_11, typecode = AMMETER_CODE, name = "阳光电表通信协议V1.1" });
