    ...
    <td width="793" valign="top" background="/images/kj/kjbg01.gif">
        ...
        <script>
            function changePage(page) {
                window.location.href = '/admin/countries/?pid=' + page;
            }
        </script>
<style type="text/css">
<!--
        ...
        <div class="subrbox01">
            ...
            <div class="sb_mid">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <%
                        int i = 1;
                        foreach (CountryCity item in ViewData["cities"] as IList<CountryCity>)
                        {
                            i++;%>
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td width="25%" align="center" class="am_line0<%=i%2 %>">
                                        <%if (AuthService.isAllow("admin", "country_edit"))
                                          { %>
                                        <a href="/admin/country_edit/<%=item.id %>">
                                            <img src="/images/sub/pencil.gif" alt="Delete" title="编辑" height="16" border="0"
                                                width="16"></a>
                                        <%} %>
                                        <%if (AuthService.isAllow("admin", "country_del"))
                                          { %>
                                        <a onclick="return confirm('你确定删除吗?')" href="/admin/country_del/<%=item.id %>">
                                            <img src="/images/sub/cross.gif" alt="Delete" title="删除" height="16" border="0" width="16"></a>
                                        <%}
                                          else
                                          {%>
                                        <img src="/images/sub/nodelete.gif" alt="Delete" title="删除" height="16" border="0"
                                            width="16">
                                        <%} %>
                                        <%if (AuthService.isAllow("admin", "cities"))
                                          { %>
                                        <a href="/admin/cities/<%=item.id %>">
                                            <img src="/images/sub/consulting.gif" alt="Delete" title="管理城市" height="16" border="0"
                                                width="16"></a>
                                        <%} %>
                                    </td>
                                </tr>
                ...
                <td height="36" colspan="5" background="/images/am/am_bg02.jpg"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="30%">
                                <%if (AuthService.isAllow("admin", "Country_Add"))
              { %>
                    <a href="/admin/Country_Add/"> <img src="/images/am/ad_bu03.gif" width="131" height="28" /></a>
                    <%} %>
                    </td>
                    <td width="70%">
