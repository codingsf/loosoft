                    ...
                    <tr>
                        ...
                        <td width="36%">
                            <%=Html.DropDownList("weather_code", new List<SelectListItem> {
                                                ...
                                                new SelectListItem { Text = "亚洲", Value = "亚洲", Selected=Model.weather_code.Equals("亚洲")},
                                                new SelectListItem { Text = "欧洲", Value = "欧洲", Selected=Model.weather_code.Equals("欧洲")},
                                                new SelectListItem { Text = "北美洲", Value = "北美洲", Selected=Model.weather_code.Equals("北美洲")},
                                                new SelectListItem { Text = "南美洲", Value = "南美洲", Selected=Model.weather_code.Equals("南美洲")},
