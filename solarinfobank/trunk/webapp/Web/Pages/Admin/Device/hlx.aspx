...
-->
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#ser").click(function() {
                 ...
                 $("#download").click(function() {
                    window.location.href = '/admin/down_device_hlx/?pname=' +$("#pname").val()+'&mname='+$("#deviceModelId").val();
                });
            ...
            function changePage(page) {
                if (!isclick)
                    window.location.href = '/admin/device_hlx/' + page;
                else
                    window.location.href = '/admin/load_device_hlx/?pname=' +$("#pname").val()+'&mname='+$("#deviceModelId").val()+'&psize='+page;
            }
      function orderby(field)
           {
                var page=<%=(ViewData["page"] as Pager).PageIndex %>;
                window.location.href = '/admin/load_device_hlx/?pname=' +$("#pname").val()+'&mname='+$("#deviceModelId").val()+'&psize='+page+"&orderby="+field;
           }
        ...
        <div class="subrbox01">
            ...
            <div class="bitab">
                <ul id="bitab">
                    ...
                    <li><a id="A1" href="/admin/device_hlx" class="onclick">汇流箱</a></li>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="10%" align="center" class="am_line0<%=i%2 %>">
                                        <%=d.getMonitorValueWithStatus(MonitorType.MIC_BUSBAR_CGQLINENUM)%>
                                    </td>
                                    <td width="10%" align="center" class="am_line0<%=i%2 %>">
                                        <%=d.getMonitorValueWithStatus(MonitorType.MIC_BUSBAR_DCUXVOLT)%>
                                    </td>
                                    <td width="10%" align="center" class="am_line0<%=i%2 %>">
                                        <%=d.getMonitorValueWithStatus(MonitorType.MIC_BUSBAR_TOTALCURRENT)%>
                                    </td>
                                </tr>
                            </table>
                        </td>
