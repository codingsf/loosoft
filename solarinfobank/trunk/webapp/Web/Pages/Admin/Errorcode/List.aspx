<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Shared/BackManager.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<Cn.Loosoft.Zhisou.SunPower.Domain.Errorcode>>" %>
...
-->
        ...
        <script>
            function changePage(page) {
                window.location.href = '/admin/errorcode/?pn=' + page;
            }
        </script>
        ...
        <div class="subrbox01">
            ...
            <div class="sb_mid">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <% int i = 0;
                       foreach (Errorcode errorCode in Model)
                       {
                           i++;
                    %>
                    <tr>
                ...
                <td height="36" colspan="5" background="/images/am/am_bg02.jpg"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="30%">
               <a href="/admin/errorcode_edit/0"> <img src="/images/am/ad_bu15.gif" width="131" height="28" /></a>
                    </td>
                    <td width="70%">
