...
<style type="text/css">
#picContainer{ padding-left:50px;  overflow:auto; height:300px;}
</style>
...
SWFUpload.Console.writeLine = function (message) {
   ...
   <table background="/images/kj/kjbg02.jpg" border="0" cellpadding="0" cellspacing="0" height="63" width="793">
          <tbody><tr>
            ...
            <td width="777"><table border="0" cellpadding="0" cellspacing="0" height="45" width="100%">
                <tbody><tr>
                  <td rowspan="2" align="center" width="7%"><img src="/images/kj/kjiico01.gif" ></td>
                  <td class="pv0216"><%=Resources.SunResource.PLANT_ADDPLANT_ADD_PLANT  %></td>

                  <td class="help_r" align="right"><a href="/help/<%=(Session["Culture"] as CultureInfo).Name%>/SolarInfo Bank User Manual.pdf" target="_blank" style="color: rgb(89, 144, 62); text-decoration: underline;">
                      <%=Resources.SunResource.MONITORITEM_HELP%> </a></td>
                </tr>
                <tr>
                  <td class="pv0212" width="75%">  &nbsp;</td>
                  <td width="18%"></td>
                </tr>
            </tbody></table></td>
            ...
            <div>
              <table border="0" cellpadding="0" cellspacing="0" height="30" width="100%">
                <tbody><tr>
                  ...
                  <td class="f_14"><strong><%=Resources.SunResource.PLANT_ADDPLANT_ADD_PLANT  %></strong></td>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
				  ...
				  <div class="kjdbu"><img src="/images/kj/kjbg06.gif" height="8" width="417"></div>
            <div class="kjdmid">
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">

                <tbody><tr>
                  <td class="pl20" height="28" width="30%"><strong><%=Resources.SunResource.PLANT_PROFILE_NAME  %> :</strong></td>
                  <td width="70%">    <%=Html.HiddenFor(Model=>Model.id) %>
                ...
                <tr>
                  <td class="pl20" height="18" width="30%"></td>
                  <td width="70%"><span id="error_name"><%=Resources.SunResource.PLANT_NAME_DEFAULT_MESSAGE%></span></td>
                </tr>
                
                
                
                <tr>
                  <td class="pl20" height="28"><strong> <%=Resources.SunResource.PLANT_PROFILE_INSTALLDATE %>:</strong></td>

                  <td width="55%"><input id="installdate" name="installdate" onclick="WdatePicker({isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})" readonly="readonly" size="18" type="text"
                                                value='<%=DateTime.Now.ToString("yyyy-MM-dd") %>' class="txtbu01" /></td>
                </tr>
                <tr>
                  <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_DESIGNPOWER %> :</strong></td>
                  <td width="55%">
                ...
                <tr>
                  <td><div style="padding-bottom: 10px;">
                    ...
                    <div class="kjdmid">
                      <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody><tr>
                          <td class="pl20" height="28" width="30%"><strong> <%=Resources.SunResource.PLANT_PROFILE_LOCATION %> :</strong></td>
                          <td width="70%"> <%= Html.TextBoxFor(model => model.location, new { @class = "txtbu01" })%></td>
                        </tr>
                        <tr>

                          <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_LONGITUDE %> :</strong></td>
                          <td width="55%"><%= Html.TextBoxFor(model => model.longitude, new { @class = "txtbu01" })%></td>
                        </tr>
                        <tr>
                          <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_LATITUDE %> :</strong></td>
                          <td width="55%"><%= Html.TextBoxFor(model => model.latitude, new { @class = "txtbu01" })%></td>
                        </tr>

                        <tr>
                          <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_MANUFACTURER %> :</strong></td>
                          <td width="55%"><%= Html.TextBoxFor(model => model.manufacturer, new { @class = "txtbu01" })%></td>
                        </tr>
                        <tr>
                          <td class="pl20" height="28"><strong> <%=Resources.SunResource.PLANT_PROFILE_MODULE_TYPE %>:</strong></td>
                          <td width="55%"><%= Html.TextBoxFor(model => model.module_type, new { @class = "txtbu01" })%></td>
                        </tr>

                        <tr>
                          <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_ANGLE %> :</strong></td>
                          <td width="55%"><%= Html.TextBoxFor(model => model.angle, new { @class = "txtbu01" })%></td>
                        </tr>
                        <tr>
                          <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_TIMEZONE %>:</strong></td>
                          <td width="55%">   <%=Html.DropDownList("timezone",Cn.Loosoft.Zhisou.SunPower.Common.TimeZone.Data,new {@class="txtbu01"} )%></td>

                        </tr>
                        
                        <tr>
                        <td height="28" class="pl20" >
                            <strong><%=Resources.SunResource.PLANT_ADDPLANT_VIDEO_MONITOR %>:</strong>
                        </td>
                        <td style="width: 30%">
            ...
            <div class="sb_mid">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody><tr>
                       ...
                       <td class="pl20" height="28" width="16%"><strong><%=Resources.SunResource.PLANT_PROFILE_COUNTRY %> :</strong></td>
                      <td width="34%"><select id="s1" class="txtbu01" style="width: 181px ; float:left; height:23px;">
                                <option><%=Resources.SunResource.PLANT_PROFILE_COUNTRY %></option>
                            </select>  <input id="country" name="country" type="text" style="display:none; width:120px; float:left;" class="txtbu01"/></td>
                            
                             <td class="pl20" height="28" width="16%"><strong><%=Resources.SunResource.PLANT_PROFILE_OPERATOR %> :</strong></td>
                      <td width="34%"><%= Html.TextBoxFor(model => model.operater, new { @class = "txtbu01" })%></td>
                      
                      
                      </tr>
                   
                    <tr>
                      <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_CITY %> :</strong></td>
                      <td>   <select id="s2" class="txtbu01" style="width: 181px; float:left; height:23px;">
                                <option><%=Resources.SunResource.PLANT_PROFILE_CITY %></option>
                            </select><input id="city" name="city" type="text" style="display:none; width:120px; float:left;" class="txtbu01"/></td>
                      <td class="pl20" height="28"><strong> <%=Resources.SunResource.PLANT_PROFILE_STREET %> :</strong></td>
                      <td><%= Html.TextBoxFor(model => model.street, new { @class = "txtbu01" })%></td>
                    </tr>

                    <tr>
                      <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_ZIPCODE %> :</strong></td>
                      <td><%= Html.TextBoxFor(model => model.postcode, new { @class = "txtbu01" })%></td>

                         <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_ADDPLANT_REDUCTRATE%>:</strong></td>
                      <td><%=Html.TextBoxFor(model => model.revenueRate, new { @class = "txtbu01"})%></td>
                    </tr>
                    <tr>
                      <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_PHONE %> :</strong></td>
                      <td><%= Html.TextBoxFor(model => model.phone, new { @class = "txtbu01" })%></td>
                       <td class="pl20" height="28"><strong><%=Resources.SunResource.PLANT_PROFILE_EMAIL %> :</strong></td>
                      <td> <%= Html.TextBoxFor(model => model.email, new { @class = "txtbu01" })%></td>
                    </tr>
                  </tbody></table>
            </div>           
          ...
          <div class="subrbox01">
            ...
            <div class="sb_mid">
			<div class="ades">
            <strong style="float:left"> <%=Resources.SunResource.PLANT_PROFILE_DESCRIPTION %>:</strong>
          ...
          <div style="padding-right: 20px; text-align: right; padding-top: 15px; padding-bottom: 15px;">
            ...
            <input name="Submit" class="subbu01" value="<%=Resources.SunResource.MONITORITEM_SAVE %>" type="submit"  />
            
            <input name="button" class="subbu01" value="<%=Resources.SunResource.MONITORITEM_CANCEL %>" type="button" style="margin-left:50PX"  onclick="window.location.href='/user/allplants'" />
