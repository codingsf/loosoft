...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
       <%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().organize %> <%=Resources.SunResource.USER_CHANGEPASSWORD_CHANGEPASSWORD%>
...
<tr>
    <td width="793" valign="top" background="/images/kj/kjbg01.gif">
        <form id="pwdform" name="pwdform" method="post" action="/plant/changepassword/<%=Model.id %>">
