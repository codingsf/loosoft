<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Shared/ContentInside.Master"
    Inherits="System.Web.Mvc.ViewPage<Plant>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <td background="/images/kj/kjbg01.gif" valign="top" width="793">
                ...
                <script>
                    ...
                    function ApplendPicContainer(picname) {
                        var appendHtml = "<img src='/ufile/" + picname + "'/>";
                        $("#picContainer").empty();
	...
	If you are using your own debug handler or when you deploy to production and
                ...
                <script language="javascript" type="text/javascript">
                    ...
                    function checkform() {
                        if ($("#virtualPlantName").val() == "") {
                            $("#error_virtualplantname").html('<em class="error" ><span class="error">&nbsp;请输入电站名</span></em>');
                            $("#virtualPlantName").get(0).focus();
                            return false;
                        }
                        return true;
                    }
                    ...
                    $().ready(function() {
                        ...
                        $("#btnSave").click(function() {
                            if (checkform()) {
                                $.ajax({
                                    type: "POST",
                                    url: "/user/savevirtualplant",
                                    data: { id: $("#id").val(),
                                        pids: getcheckboxes('plant', 'ref'),
                                        vname: $("#virtualPlantName").val(),
                                        descr: $("#descr").val(),
                                        s1: $("#s1").val(),
                                        s2: $("#s2").val(),
                                        guid: $("#pic").val(),
                                    ...
                                    success: function(result) {
                                        if (result == "ok")
                                            parent.window.location.href = "/user/allplants";
                                    }
                                });
                            }
                        });
                        ...
                        $.each(ids, function(key, value) {
                            $("[name='plant']").each(function() {
                                if (value == $(this).attr("ref"))
                ...
                <form action="/user/savevirtualplant" method="post" id="editForm">
                <div class="subrbox01">
                    <div>
                    ...
                    <div class="sb_mid">
                        <table width="100%" cellpadding="0" cellspacing="0" style="line-height: 24px;">
                            <tr>
                                <td width="16%" height="40" align="right" style="padding-right: 5px;">
                                    电站名：
                                </td>
                                <td width="84%" style="padding-left: 5px;">
                                    <input id="virtualPlantName" name="virtualPlantName" type="text" class="txtbu01"
                                        style="width: 300px;" value="<%=Model.name %>" />
                                    <span class="red">*</span><span id="error_virtualplantname"></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="16%" height="40" align="right" style="padding-right: 5px;">
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <select id="s1" class="txtbu01" name="s1" style="width: 181px; height: 23px; float: left;">
                                        <option>
                                            <%=Resources.SunResource.AUTH_REG_COUNTRIES %></option>
                                    </select>
                                    <input type="hidden" id="cty" value="<%=Model.city %>" />
                                    <input type="hidden" id="id" value="<%=Model.id %>" />
                                    <input type="hidden" id="cy" value="<%=Model.country %>" />
                                </td>
                            </tr>
                            <tr>
                                <td width="16%" height="40" align="right" style="padding-right: 5px;">
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <select id="s2" class="txtbu01" name="s2" style="width: 181px; float: left;">
                                        <option>
                            ...
                            <tr>
                                ...
                                <td width="84%" style="padding-left: 5px;">
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="text" id="uoloadFilePath" class="txtbu01" style="width: 150px" />
                                            </td>
                                            <td>
                                                <div id="spanButtonPlaceholder" style="margin-top: 10px; border: solid 1px red; line-height: 22px;">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" id="sutpic" value="<%=Model.structPic%>" />
                                    <input type="hidden" id="pic" value="<%=Model.pic%>" />
                                </td>
                            </tr>
                            <tr>
                                <td height="120" align="right" valign="top" class="down_line02" style="padding-right: 5px;">
                                    说明：
                                </td>
                                <td class="down_line02" style="padding-left: 5px;">
                                    <textarea name="descr" id="descr" class="txtbu05" style="width: 300px;"><%=Model.description%></textarea>
                                </td>
                            </tr>
                            <tr class="down_line01">
                                ...
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <%int i = 0;
                                              foreach (SelectListItem item in ViewData["comPlants"] as List<SelectListItem>)
                                              {
                                                  if (i++ % 2 == 0 && i > 1)
                                            ...
                                            <td width="33%" style="padding-left: 5px;">
                                                <strong>
                                                    <input type="checkbox" name="plant" value="checkbox" ref="<%=item.Value %>" <%=(item.Selected?"checked=checked":"") %> />
                                                </strong>
                                                <%=item.Text%>
                                            </td>
                                            <%} %>
