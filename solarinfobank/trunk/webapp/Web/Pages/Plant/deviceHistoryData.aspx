...
<input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Model.timezone,"yyyyMMdd")%>" id="curYYYYMMDD" />
<input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Model.timezone,"yyyyMMdd")%>" id="initCurYYYYMMDD" />
          ...
          <tr>
            ...
            <td width="777"><table width="98%" height="45" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="93%" class="pv0216"><%=Resources.SunResource.DEVICE_DEVICE_HISTORYRUN_DATA%></td>
                </tr>
                <tr>
                        ...
                        <tr>
                          ...
                          <td width="50%"  class="f_14">
                           ...
                           <table border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="/images/chartLeft.gif" id="Img1" width="24" height="21" onclick="PreviouNextChange('left')" style="cursor:pointer;" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img src="/images/chartRight.gif" width="24" height="21" id="Img2" onclick="PreviouNextChange('right')" style="cursor:pointer;"/>
                                    </td>
                                </tr>
                            </table>
                            </div> 
                            ...
                            <div id='history_container' style="width: 100%; margin-left: 0px;
                                margin-right: 20px;">
