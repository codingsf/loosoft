        ...
        <div class="gf_top">
            <div class="gf_toptittle">
                ...
                <div class="gf_toptittlel">
                    <img src="<%=ViewData["logo"] %>" border="0" /></div>
            </div>
        </div>
    </div>
                    ...
                    <%--           <tr>
                        <td height="50">
                            <table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" background="/images/gf/tlbg.gif">
                                <tr>
                                    <td width="8">
                                        <img src="/images/gf/tll.gif" width="8" height="34" />
                                    </td>
                                    <td width="156">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="13%">
                                                    <img src="/images/gf/kjjk.gif" width="16" height="16" />
                                                </td>
                                                <td width="87%">
                                                    <a href="#" style="color: #E87006; text-decoration: underline;">电站设备PR性能图</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="10">
                                        <img src="/images/gf/tline.gif" width="3" height="34" />
                                    </td>
                                    <td width="569">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="4%">
                                                    <img src="/images/gf/kjjh.gif" width="16" height="16" />
                                                </td>
                                                <td width="96%">
                                                    <a href="#" style="color: #E87006; text-decoration: underline;">电站设备PR性能图</a>
                                                </td>
                                    ...
                                    <td width="8" align="right">
                                        <img src="/images/gf/tlr.gif" width="7" height="34" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td align="center">
                            <div class="kjrb">
                                <table width="92%" height="43" border="0" align="left" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="21%">
                                            <img src="/images/gf/ico<%=hs["id"] %>.gif" width="60" height="55" />
                                        </td>
                                        <td width="79%" align="left" class="kjli">
                                            <%=hs["displayName"]%><br />
                                            <%=hs["data"] %>
                                            <%=hs["unit"] %>
                                        </td>
                            ...
                            %>
                                    <td width="50%">
                                        ...
                                        <span class="lbl">
                                            ...
                                            <br />
                                            <%=Resources.SunInfoResource.USER_OVERVIEW_PLANT_CURRENT_POWER%>: 0 kW </span>
                                        <%}%>
