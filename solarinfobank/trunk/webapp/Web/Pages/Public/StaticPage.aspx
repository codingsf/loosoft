...
<div style="height:120px;"></div><div style=" width:636px; height:94px; margin:0px auto; background:url(../../Images/wzz.gif) no-repeat; font-size:24px; color:#8A8A8A; padding-top:200px; text-align:center;"><%=Resources.SunResource.PAGE_UNDER_CONSTRUCTION%></div><div style="height:150px;"></div>
</asp:Content>
