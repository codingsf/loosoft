...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function changetab(tab) {
            $("#bitab1 a").each(function() {
                $(this).removeClass("onclick");
            });
            $(tab).addClass("onclick");
        }
            ...
            <td background="/images/kj/kjbg01.jpg" valign="top" width="793">
                ...
                <table background="/images/kj/kjbg02.jpg" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tbody>
                        <tr>
                            <td width="8">
                                <img src="/images/kj/kjico02.jpg" height="63" width="8">
                            </td>
                            <td width="777">
                                <table border="0" cellpadding="0" cellspacing="0" height="45" width="100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="help_r" align="right">
                                                <a href="/help/<%=(Session["Culture"] as CultureInfo).Name%>/SolarInfo Bank User Manual.pdf"
                                                    target="_blank" style="color: rgb(89, 144, 62); text-decoration: underline;">
                                                    <%=Resources.SunResource.MONITORITEM_HELP%>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="pv0212" width="75%">
                                                &nbsp;
                                            </td>
                                            <td width="18%">
                                            </td>
                            ...
                            <td align="right" width="6">
                                <img src="/images/kj/kjico03.jpg" height="63" width="6">
                            </td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" height="30" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="f_14">
                                        <strong>
                                            <%=Resources.SunResource.PLANT_ADDPLANT_ADD_PLANT  %></strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
new SelectListItem(){ Text= Resources.SunResource.PLANT_EDIT_DISABLE, Value="false"}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="55%">
                                                                <%=Html.TextBox("basePrice", string.Empty, new { @class = "txtbu01" })%>
                                                                元
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="55%">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <input class="txtbu01" id="structPic" name="structPic" value="" type="text"><input type="hidden" id="sutpic" name="sutpic" />
                                                                        </td>
                                                                        <td>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="fstart" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>到:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="fend" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>电价:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01" style="width: 100px" name="fprice" />
                                            元
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="pstart" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>到:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="pend" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>电价:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01" style="width: 100px" name="pprice" />
                                            元
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="gstart" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>到:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="gend" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>电价:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01" style="width: 100px" name="gprice" />
                                            元
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="jstart" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>到:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01 Wdate" style="width: 100px" name="jend" onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:false,lang:'<%=  (Session["Culture"] as System.Globalization.CultureInfo).Name.ToLower()%>'})"
                                                readonly="readonly" />
                                        </td>
                                        <td class="pl20">
                                            <strong>电价:</strong>
                                        ...
                                        <td>
                                            <input type="text" class="txtbu01" style="width: 100px" name="jprice" />
                                            元
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="34%">
                                            ...
                                            <input id="country" name="country" type="text" style="display: none; width: 120px;
                                                float: left;" class="txtbu01" />
                                        </td>
                                        <td class="pl20" height="28" width="18%">
                                            <strong>
                                    ...
                                    <tr>
                                        <td class="pl20" height="28">
                                            <strong>
                                                <%=Resources.SunResource.PLANT_PROFILE_STREET%>:</strong>
                                        </td>
                                        <td>
    ...
    <script>
        $().ready(function() {
            ...
            $(".kjtt01 :a", window.parent.document).each(function() {
                if ($(this).attr("class") == "lefttabclick") {
                    sel = true;
                }
            });
            if (!sel) {
                var link = parent.document.getElementById("defaultlink");
                $(link).addClass("lefttabclick");
            };
        });
    </script>
