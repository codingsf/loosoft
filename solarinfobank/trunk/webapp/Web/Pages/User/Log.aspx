    ...
    <script type="text/javascript">
        ...
        function changePage(no) {
            ...
            $.ajax({
                type: "POST",
                url: "/user/log",
                data: {userId:<%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().id %>, year: $("#year").attr("value"), startDate: $("#startDate").attr("value"), endDate: $("#endDate").attr("value"), state: $("#state").val(), plant: $("#plant").val(), pindex: pageNo, errorType: cbxvalue('errorCode'), logList: cbxvalue('cbx'), ctype: $("#ctype").val() },
        ...
        <div class="subrbox03">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="15%">
                      ...
                      <td width="15%">
                       ...
                       <td width="15%">
                        <%=Resources.SunResource.USER_LOG_PLANT %>:
                    </td>
                    <td width="10%">
                ...
                <tr>
                    ...
                    <td>
                        <select name="plant" id="plant" class="txtbu01" style="width:120px">
                            <option value="-1">
                                <%=Resources.SunResource.USER_LOG_ALL_PLANTS %></option>
                            <% foreach (Plant plant in Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().displayPlants)
                               { %>
                    ...
                    <td>
                        <select id="errorCode" multiple="multiple" name="errorCode" size="5" style="width: 80px">
                            <option value="">
