...
<!--
<%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().organize %>  <%=Resources.SunResource.SHARED_INSIDEMASTERPAGE_INVEST_INCOME_COMPARED  %> 
-->
    <script type="text/javascript">
        ...
        var curChart;
        function largepec() {
            $("#toLargeChart").colorbox({ width: "100%", inline: true, href: "#large_containerpec" });
            if (curChart == "MonthChart")
                monthChart("large_containerpec", 130, true);
            else if (curChart == "YearChart") {
                yearChart("large_containerpec", 130, true);
            } else if (curChart == "TotalChart") {
                totalChart("large_containerpec", 130, true);
            } else
                dayChart("large_containerpec", 130, true);
        }
        ...
        function monthChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantchart/UserMonthDDKwpChart",
                data: {userId: <%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().id%>,startYYYYMMDD: $("#startYYYYMMDD").val(), endYYYYMMDD: $("#endYYYYMMDD").val(), chartType: 'column' },
                success: function(result) {
                    if (appendChartError(curContainer, result, ajaxImgTop)) {
                        return;
                    }
        ...
        function yearChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantChart/UserYearMonthKwpChart",
                data: {userId: <%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().id%>,year: $("#year").val(), chartType: 'column' },
                success: function(result) {
                    if (appendChartError(curContainer, result, ajaxImgTop)) {
                        return;
                    }
        ...
        function totalChart(curContainer, ajaxImgTop, isLarge) {
            ...
            $.ajax({
                type: "POST",
                url: "/plantChart/UserTotalKwpChart",
                data: {userId: <%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().id%>,chartType: 'column' },
                success: function(result) {
                    if (appendChartError(curContainer, result, ajaxImgTop)) {
                        return;
                    }
     ...
     function changePreDay(obj) {
        ...
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyy")%>" id="year" />
        <input type="hidden" value="<%=ChartType.column+","+ChartType.line %>" id="chartType" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyyMM")%>" id="month" />   
        <input type="hidden" value="60" id="intervalMins" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyyMMdd")%>00" id="startYYYYMMDDHH" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyyMMdd")%>23" id="endYYYYMMDDHH" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyyMM")%>01" id="startYYYYMMDD" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyyMM")+CalenderUtil.getCurMonthDays()%>" id="endYYYYMMDD" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyy")%>01" id="startYM" />
        <input type="hidden" value="<%=CalenderUtil.curDateWithTimeZone(Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().timezone,"yyyy")%>12" id="endYM" />
        ...
        <div class="subrbox01">
            ...
            <div class="sb_mid">
                ...
                <div class="z_big">
                    <a id="toLargeChart" href="javascript:void(0)" onclick="largepec()" onfocus="javascript:this.blur();">
                    </a></div>
                <div class="chart">
                    <div class="chart_box">
                        <div id="chartDiv">
                        ...
                        <div style="display: none">
                            <center>
                                <div id='large_containerpec' style="width: 90%; height: 450px; margin-left: 50px; margin-right: 50px; text-align:center;">
                                </div>
                            </center>
                        </div>
...
<script>    document.title = '<%=Cn.Loosoft.Zhisou.SunPower.Service.UserUtil.getCurUser().organize %>  <%=Resources.SunResource.SHARED_INSIDEMASTERPAGE_INVEST_INCOME_COMPARED %>'</script>
