...
<%=Resources.SunResource.USER_ADDUSER_SEND_ACCOUNT_MAIL%> </td>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
                  ...
                  .txtbu05 li{ height:25px; line-height:25px; float:left; width:100%; clear:both;}
                  .txtbu05 li input{ margin-right:5px; margin-left:5px; }
                  .txtbu05 li span{ margin-right:5px; margin-left:5px; line-height:23px; height:23px;}
