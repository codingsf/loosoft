            ...
            <div class="sb_mid">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <% int i = 0;
                       ...
                       foreach(var plantUserVO in ViewData["puvos"] as IList<Cn.Loosoft.Zhisou.SunPower.Service.vo.PlantUserVO>)
                       {
                           if (plantUserVO.user.id == Model.id) continue;
                           i++;
                    %>
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="down_line0<%=i%2 %>">
                                <tr>
                                    <td width="25%" height="35" align="center">
                                    <div title="<%=plantUserVO.user.username %>" style="width:180px; overflow:hidden">
                                    <%=plantUserVO.user.username %></div>
                                    </td>
                                    <td width="20%" align="center">
                                    <%=plantUserVO.plantRole.displayName %>
                                    </td>
                                    <td width="30%" align="center">
                                      <div style="width:220; overflow:hidden"> <%=plantUserVO.user.email %></div>
                                    </td>
                                    <td width="25%" align="center">
                                        <a href="/user/viewinfo/<%=plantUserVO.user.id %>"><img alt="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>" title="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>" src="/Images/sub/ck.gif" border="0" height="16" width="16"></a>
                                        <%if(plantUserVO.user.ParentUserId==Model.id){ %>
                                        <a href="/user/useredit?uid=<%=plantUserVO.user.id %>&role=<%=plantUserVO.plantRole.id %>">
                                            <img src="/images/sub/pencil.gif" alt="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>" title="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>" border="0" width="16" height="16"></a>
                                        <%} %>
                                        <a href="/user/userplants?uid=<%=plantUserVO.user.id %>">
                                        ...
                                        <a href="/user/deleteuser/?uid=<%=plantUserVO.user.id %>">
