                                        ...
                                        <tr>
                                            <td width="25%" height="35" align="center">
                                                <div title="<%= Model.username %>" style="width: 180px; overflow: hidden">
                                                    <img src="/images/sub/user_mature.gif" />
                                                    <%=Html.Encode( Model.username)%></div>
                                            </td>
                                            
                                            <td width="30%" align="center">
                                                <div style="width: 220; overflow: hidden">
                                                    <%=Html.Encode(Model.email)%></div>
                                            </td>
                                            <td width="25%" align="center">
                                                <img alt="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>" title="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>"
                                                    src="/Images/sub/ck00.gif" border="0" height="16" width="16">
                                                <a href="/user/edit">
                                                    <img src="/images/sub/pencil.gif" alt="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>"
                                                        title="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>" border="0" width="16"
                                                        height="16"></a>
                                                <img src="/images/sub/view_c00.gif" border="0" width="16" height="16" alt="<%=Resources.SunResource.USERS_ASSIGN_PLANT %>"
                                                    title="<%=Resources.SunResource.USERS_ASSIGN_PLANT %>">
                                                <img src="/images/sub/cross00.gif" title="<%=Resources.SunResource.PLANT_ADDPLANT_DELETE %>"
                                                    alt="<%=Resources.SunResource.PLANT_ADDPLANT_DELETE %>" border="0" width="16"
                                                    height="16">
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="down_line0<%=i%2 %>">
                                        <tr>
                                            ...
                                            <td width="25%" align="center">
                                                <a href="/user/portalviewinfo/<%=user.id %>">
                                                    <img alt="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>" title="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>"
                                                        src="/Images/sub/ck.gif" border="0" height="16" width="16"></a> <a href="/user/portaluseredit?uid=<%=user.id %>&role=">
                                                            <img src="/images/sub/pencil.gif" alt="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>"
                                                                title="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>" border="0" width="16"
                                                                height="16"></a> <a href="/user/portaluserplants?uid=<%=user.id %>">
                                                                    <img src="/images/sub/xs.gif" border="0" width="16" height="16" alt="<%=Resources.SunResource.USERS_ASSIGN_PLANT %>"
                                                                        title="<%=Resources.SunResource.USERS_ASSIGN_PLANT %>"></a>
                                               
                                               
                                                <a href="/user/structconfig?id=<%=user.id %>">
                                                    <img src="/images/sub/node-design.gif" title="电站结构图" alt="电站结构图" border="0" width="16" height="16"></a>
                                                    
                                                    
                                                <a href="/user/deleteportaluser/?uid=<%=user.id %>">
                                                    <img src="/images/sub/cross.gif" onclick="return confirm('<%=Resources.SunResource.MONITORITEM_SURE_DELETE %>');"
                                                        title="<%=Resources.SunResource.PLANT_ADDPLANT_DELETE %>" alt="<%=Resources.SunResource.PLANT_ADDPLANT_DELETE %>"
