                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="down_line0<%=i%2 %>">
                                        <tr>
                                            ...
                                            <td width="25%" align="center">
                                                <a href="/user/viewinfo/<%=user.id %>">
                                                    <img alt="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>" title="<%=Resources.SunResource.CUSTOMREPORT_VIEW %>"
                                                        src="/Images/sub/ck.gif" border="0" height="16" width="16"></a> <a href="/user/useredit?uid=<%=user.id %>&role=">
                                                            <img src="/images/sub/pencil.gif" alt="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>"
                                                                title="<%=Resources.SunResource.PLANT_REPORTCONFIG_EDIT %>" border="0" width="16"
                                                                height="16"></a> <a href="/user/userplants?uid=<%=user.id %>">
