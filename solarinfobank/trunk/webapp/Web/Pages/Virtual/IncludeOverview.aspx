                    ...
                    <table width="92%" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="79%" class="kjli">
                                ...
                                <br />
                                <span class="sz_fb"><%=(Model.TotalEnergy/40).ToString("0") %></span> <%=Resources.SunResource.PLANT_OVERVIEW_FAMILIES%>         
                            </td>
                        </tr>
                    </table>
                </div>
...
<div class="subrbox01">
    ...
    <div class="sb_mid">
        <div class="subico01">
            <ul id="change">
                <li style="cursor: pointer; <%if (Model.isVirtualPlant){ %>display:none; <%}%> "><a id="DayChart" class="onclick" href="javascript: void(0);">
