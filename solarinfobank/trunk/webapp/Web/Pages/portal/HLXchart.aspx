        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="background: url(/images/gf/tci/tc02.gif) bottom repeat-x;">
                    <div class="bitab0">
                        <ul id="bitab0">
                            <li><a href="javascript:void(0);" onclick="changeChartTab(1);">
                                <%=Resources.SunResource.DEVICETYPE_1 %></a></li>
                            <li><a href="javascript:void(0);" onclick="changeChartTab(2);" class="onclick">
                                ...
                                <table width="100%" border="0" bordercolor="#A8A8A8" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="10" width="8%" height="25" style="border: none">
                                            <%=Resources.SunResource.DEVICE_DAY_TOTALCURRENT_COMPARE_DETAIL%>
                                        </td>
                                    </tr>
                                </table>
