...
<head>
    ...
    function monthChart(curContainer, ajaxImgTop, isLarge) {
        ...
        $.ajax({
            type: "POST",
            url: "/plantchart/PlantFgpjMonthChart",
            data: { pid: $("#pid").val(), YYYYMM: $("#YYYYMM").val(), chartType: 'pie' },
            success: function(result) {
    ...
    function yearChart(curContainer, ajaxImgTop, isLarge) {
        ...
        $.ajax({
            type: "POST",
            url: "/plantChart/PlantFgpjYearChart",
            data: { pid: $("#pid").val(), year: $("#year").val(), chartType: 'pie' },
            success: function(result) {
                if (appendChartError(curContainer, result, ajaxImgTop)) {
                    return;
                }
    ...
    function totalChart(curContainer, ajaxImgTop, isLarge) {
        ...
        $.ajax({
            ...
            data: { pid: $("#pid").val(), chartType: $("#chartType").val() },
            success: function(result) {
                if (appendChartError(curContainer, result, ajaxImgTop)) {
                    return;
                }
    ...
    function dayChart(curContainer, ajaxImgTop, isLarge) {
        ...
        $.ajax({
            type: "POST",
            url: "/plantchart/PlantFgpjDayChart",
            data: { pid: $("#pid").val(), YYYYMMDD: $("#YYYYMMDD").val(), chartType: 'pie', intervalMins: $("#intervalMins").val() },
            success: function(result) {
                if (appendChartError(curContainer, result, ajaxImgTop)) {
                    return;
                }
...
<body style="background: url(/images/gf/gf_tcbg.jpg) top repeat-x;">
                ...
                <div >
                    ...
                    <div>
                        <div id="chartDiv">
                            ...
                            <div id='container' style='width: 97%; height: 480px; margin-left: 2px; margin-right: 2px;'>
                            </div>
                        </div>
    ...
    <!--
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD"  style="border-collapse:collapse; line-height:24px; text-align:center">
          <tr>
            ...
            <td colspan="4" bgcolor="#F3F3F3">电费（元）</td>
            <td width="6%" rowspan="2" bgcolor="#F3F3F3">基础电价(元)</td>
            <td width="8%" rowspan="2" bgcolor="#F3F3F3">总电价(元)</td>            
          </tr>
          <tr>
    ...
    <div class="gf_footer">
        <div class="gf_boxb">
            <span class="tspanl">
                <%=ViewData["footer"] %></span> <span class="tspanr">版权 @ 2012 SolarInfo Bank , v1.0.17
