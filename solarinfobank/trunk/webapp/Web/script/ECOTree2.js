        ...
        if (!node._isAncestorCollapsed()) {
            switch (this.render) {
                case "CANVAS":
                    ...
                    //HTML part...
                    s.push('<div id="' + node.id + '" class="econode" style="{border:solid 1px #D4D4D4; top:' + (node.YPosition + this.canvasoffsetTop) + '; left:' + (node.XPosition + this.canvasoffsetLeft) + '; width:' + node.w + '; height:' + node.h + ';}" ');
                    ...
                    if (node.canCollapse) {
                        ...
                        s.push('<img title="' + ((node.isCollapsed) ? '展开' : '收缩') + '" border=0 src="' + ((node.isCollapsed) ? this.config.collapsedImage : this.config.expandedImage) + '" >');
                        s.push('</a>');
                ...
                case "VML":
                    ...
                    s.push('>');
                    s.push('<v:textbox inset="0.0px,0.0px,0.0px,0.5px" ><font face=Verdana size=1>');
