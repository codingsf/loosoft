$(function() {
    //必填项加红*
//    $("input[class*=:required]").after("<span style='color:Red'> *</span>")
//    $("input[class*=:min_length]").after("<span style='color:Red'> *</span>")
});
//弹出信息样式设置
Vanadium.config = {
...
Vanadium.setupValidatorTypes = function() {
    ...
    }, '请输入正确的网址,比如:http://www.zhisou.net'],
    //日期格式
    ['date_au', function(v) {
        if (Vanadium.validators_types['empty'].test(v)) return true;
