...
<div id="login_boxtxt">
  ...
  <input type="hidden" name="id" value="${id}"/>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="24%" height="32" align="right" class="sytt"><strong>学号</strong></td>
        <td width="76%">		
		    <input type='text' id='j_username' name='j_username' class="txtsy"  style="width: 140px;"
      ...
      <tr>
        ...
        <td>
        	<input type='password' id='j_password' name='j_password' class="txtsy" style="width: 140px;"/>
        </td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="88%" style="color:#26A9E8;">记住我</td>
            </tr>
        </table></td>
      </tr>
      <tr>
...
<div id="footer" style="width: 100%; text-align: center; height: 20px;" ><font size="8">软件提供：合肥智搜信息科技， 版权所有 © 2012 </font></div>
</div>
