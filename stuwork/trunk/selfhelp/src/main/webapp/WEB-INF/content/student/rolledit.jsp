...
<div class="emb"></div>
<form id="dataForm" name="dataForm" action="${ctx}/student/rolledit!save.action" method="post">
	
<div class="mid1003_r">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">

    <tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');" class="tbigtt">学籍信息修改</td>
    </tr>
        <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
	          ...
	          <td bgcolor="#F1F4F9" >   
			<input id="headTeacher" name="headTeacher" value="${studentDTO.headTeacher}"
			type="text" class="wid40" />
	          </td>
	           <td height="30"  align="right" bgcolor="#F1F4F9" class="tbg01 pr10">班主任电话&nbsp;</td>
	          <td bgcolor="#F1F4F9" >
		       <input id="headTeacherPhone" name="headTeacherPhone" value="${studentDTO.headTeacherPhone}"
			type="text" class="wid40" />
	          </td>
        </tr>
        ...
        <tr>
	          ...
	          <td >
		     <input id="counselor" name="counselor" value="${studentDTO.counselor}"
			type="text" class="wid40" />
	          </td>
	           <td height="30"  align="right" class="tbg02 pr10">辅导员电话&nbsp;</td>
	          <td >
		      <input id="counselorPhone" name="counselorPhone" value="${studentDTO.counselorPhone}"
			type="text" class="wid40" />
	          </td>
        </tr>
