 ...
 * @since 2011-3-1
 */
public class MajorCountAction extends CrudActionSupport<Object>
{
    /**
    ...
    {
        this.majorVOs = archivesManager.majorCount();
        return SUCCESS;
    }
    ...
    public String printExcel() throws Exception
    {
        ...
        String titleStr = "学院;专业;状态;人数;专业总人数";// 标题
        ...
        if (null != majorVOs && majorVOs.size() > 0)
        {
            for (CountVO countVO : majorVOs)
            {
            ...
            try
            {
                ...
                // 不生成文件，直接生成文件输出流供下载
                downLoad.downLoad("档案统计-按专业统计.xls", excel, response);
    ...
    public List<CountVO> getMajorVOs()
    {
        return majorVOs;
    }
