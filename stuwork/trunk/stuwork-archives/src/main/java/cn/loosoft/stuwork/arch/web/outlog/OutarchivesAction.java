 ...
 */
@Namespace("/outlog")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "outarchives.action", type = "redirect") })
public class OutarchivesAction extends CrudActionSupport<OutLog>
{

    private static final long serialVersionUID = 1L;

    private OutlogManager     outlogManager;                               // 调出管理

    private OutLog            outLog;                                      // 调出实体

    private Page<OutLog>      page             = new Page<OutLog>(
    ...
    public String list() throws Exception
    {
        ...
        if (!page.isOrderBySetted())
        {
            ...
            page.setOrderBy("outDate");
        }

        page = outlogManager.search(page, filters);
    ...
    public String save() throws Exception
    {
        ...
        outLog.setType(OutlogType.getDesc(outLog.getType()));
        // TODO Auto-generated method stub
        return RELOAD;
    }
