 ...
 */
@Namespace("/sys")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "outtype.action", type = "redirect") })
public class OuttypeAction extends DictionaryAction
{
    // --CRUD Action 函数-- //
    ...
    public String list() throws Exception
    {
        ...
        page = dictionaryManager.search(page, Dictionary.DDFS);
        return SUCCESS;
    }
    ...
    public String save() throws Exception
    {
        ...
        {
            entity.setType(Dictionary.DDFS);
