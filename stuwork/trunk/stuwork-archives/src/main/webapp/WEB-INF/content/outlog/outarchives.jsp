...
<div class="mid1003_r">
    ...
    <tr>
		<td bgcolor="#FFFFFF">
		<form id="searchForm" name="searchForm" action="${ctx}/outlog/outarchives!list.action" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>调出记录</strong></td>
          </tr>
		  <tr>
	          ...
	          <td width="10%" class="tbg03"><strong>调档单位</strong></td>
	          <td width="10%" class="tbg03"><strong>调出时间</strong></td>
	           <td width="10%" class="tbg03"><strong>经办人</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>"><fmt:formatDate value="${outDate}" type="date" pattern="yyyy-MM-dd HH:mm:ss" />&nbsp;</td>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		      <a href="${ctx}/outlog/outarchives!input.action?id=${id}&stuId=${stuId}">详情</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
