...
<script>
function cc(){
	document.getElementById("searchForm").action="outlog!list.action";
	document.getElementById("searchForm").submit();
}
	</script>
...
<div class="mid1003_r">
    ...
    <tr>
		<td bgcolor="#FFFFFF">
		<form id="searchForm" name="searchForm" action="${ctx}/outlog/outlog!list.action" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>调出管理</strong></td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		      <a href="${ctx }/outlog/outlog!input.action?stuId=${stuId}">调出</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
