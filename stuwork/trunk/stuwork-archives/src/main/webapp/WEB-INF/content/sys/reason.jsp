...
<div class="mid1003_r">
<form id="searchForm" action="${ctx}/sys/reason!list.action" method="post">
<input type="hidden" name="type" value=${type} />
<input type="hidden" name="page.pageNo" id="pageNo" value="${page.pageNo}"/>
<input type="hidden" name="page.orderBy" id="orderBy" value="${page.orderBy}"/>
<input type="hidden" name="page.order" id="order" value="${page.order}" />
</form>
<form action="${ctx}/sys/reason!deletes.action" method="post" id="deleteForm">
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<div class="tabhv">
		<ul>
			<li><a href="${ctx }/sys/reason!input.action">新增</a></li>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>调档理由列表</strong></td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		          <a href="${ctx}/sys/reason!input.action?id=${id}">修改</a>
		          <a href="#" onclick="delOneRecord('${id }','${ctx}/sys/reason!delete.action');">删除</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
