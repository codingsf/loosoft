	...
	<!--
	    $(document).ready(function(){
		   ...
		   $("#printexcel").click(function(){
				document.getElementById("dataForm").action="college-count!printExcel.action";
...
<div class="mid1003_r">
    ...
    <tr>
       <td height="27"  style="background: url('../images/login/tabbg01.jpg');" class="tbigtt">按学院统计</td>
    </tr>
	   ...
	   <form action="" id="dataForm" name="dataForm" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
	          ...
	          <td width="15%" class="tbg03"><strong>状态</strong></td>
	          <td width="10%" class="tbg03"><strong>人数</strong></td>
	          <td width="10%" class="tbg03"><strong>学院总人数</strong></td>
	                  
		  </tr>
		  <s:iterator  value="collegeVOs"  status="status">
		  <tr>
