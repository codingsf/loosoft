...
<div class="mid1003_r">
    ...
    <tr>
		<td bgcolor="#FFFFFF">
		<form id="searchForm" name="searchForm" action="${ctx}/outlog/outlog!outRecord.action" method="post">
		<table id="filter" width="100%" style="height: 35px" border="0" cellpadding="0" cellspacing="0" bgcolor="#F7E582" class="br07" >
         ...
         <input type="hidden" name="commonPage.pageNo" id="pageNo" value="${pageNo}" />
		</form>
		
		<form  method="post" id="submitForm">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>调出回执录入</strong></td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		      <a href="${ctx }/outlog/outlog!outRecordInput.action?id=${id}">回执录入</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
