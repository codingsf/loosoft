...
<form id="dataForm" name="dataForm" action="${ctx}/sys/outtype!save.action" method="post" onsubmit="return submitForm(this)">
...
<div class="mid1003_r">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      ...
      调档方式(<span class="redz">*</span>为必填)</td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="35%" height="30" align="right" class="tbg02 pr10">调档方式<span class="redz">* </span></td>
