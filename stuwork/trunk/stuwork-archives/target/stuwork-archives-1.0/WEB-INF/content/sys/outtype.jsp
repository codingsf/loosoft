...
<div class="mid1003_r">
<form id="searchForm" action="${ctx}/sys/outtype!list.action" method="post">
...
<form action="${ctx}/sys/stuff!deletes.action" method="post" id="deleteForm">
<input type="hidden" name="type" value="${type }" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<div class="tabhv">
		<ul>
			<li><a href="${ctx }/sys/outtype!input.action?type=ddfs">新增</a></li>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>调档方式列表</strong></td>
          </tr>
		  <tr>
	          ...
	          <td width="16%" class="tbg03"><strong>调档方式</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		        <a href="${ctx}/sys/outtype!input.action?id=${id}">修改</a>
		        <a href="#" onclick="delOneRecord('${id }','${ctx}/sys/outtype!delete.action');">删除</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
