...
<div class="emb"></div>
<div class="mid1003_r">
<form id="searchForm" action="${ctx}/sys/stuff!list.action" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<div class="tabhv">
		<ul>
			<li><a href="${ctx }/sys/stuff!input.action?type=rkcl">新增</a></li>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>入库材料列表</strong></td>
          </tr>
		  <tr>
	          ...
	          <td width="16%" class="tbg03"><strong>材料名</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		        <a href="${ctx}/sys/stuff!input.action?id=${id}">修改</a>
		        <a href="#" onclick="delOneRecord('${id }','${ctx}/sys/stuff!delete.action');">删除</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
