...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/archives/archives.action";
...
<div class="mid1003_l">
  <div>
    <div class="leftlist_ico">档案查询</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../archives/archives.action" target="index">档案查询</a></li>
        </ul>
      </div>
