...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/store/store.action";
...
<div class="mid1003_l">
  <div>
    <div class="leftlist_ico">档案柜管理</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../store/store.action" target="index">档案柜编号查询</a></li>
        </ul>
      </div>
