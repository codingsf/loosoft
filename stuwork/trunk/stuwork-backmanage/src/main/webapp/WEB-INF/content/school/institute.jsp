...
<div class="mid1003_r">
	...
	<tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');">
	      <div class="tabhv">
	        <ul>
	          	<li><a href="institute!input.action" >新增学院</a></li>
    ...
    <tr>
		...
		<form action="${ctx}/school/institute!deletes.action" method="post" id="deleteForm">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
		  ...
		  <tr>
	          ...
	          <td width="5%" class="tbg03"><strong>学院代码</strong></td>
	          <td width="10%" class="tbg03"><strong>名称</strong></td>
	          <td width="5%" class="tbg03"><strong>院长</strong></td>
	          <td width="20%" class="tbg03"><strong>学院办公室地址</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">${obj.address}&nbsp;</td>    
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
			    <a href="${ctx}/school/institute!input.action?id=${obj.id }">修改</a> 
			    <a href="#" onclick="delOneRecord('${obj.id }','${ctx}/school/institute!delete.action');">删除</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
	...
	<div>
	<span class="btn2">
	   <a href="${ctx }/school/institute!printExcel.action"><span>导出Excel</span></a>
	</span>
	</div>
