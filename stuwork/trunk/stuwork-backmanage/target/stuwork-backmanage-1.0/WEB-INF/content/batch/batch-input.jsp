...
<div class="mid1003_r">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      ...
      <s:if test="id == null">新增</s:if><s:else>修改</s:else>批次(<span class="redz">*</span>为必填)
      </td>
    </tr>
    ...
    <tr>
      <td bgcolor="#FFFFFF">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="35%" height="30" align="right" class="tbg02 pr10">年份<span class="redz">* </span></td>
	          <td width="65%" >
	          	<input type="text"  name="year" class="wid17" id="year"  value="${year}" <s:if test="id != null">readonly="readonly"</s:if> />
	          </td>
	        </tr>
	        ...
	        <tr>
	          ...
	          <td bgcolor="#F1F4F9">
	          	<s:if test="id !=null">
			       <input style="width:250px;" type="text"  name="season" class="wid17" id="season"  value="${season}" readonly="readonly" />
			    </s:if>
			    <s:else>
	        ...
	        <tr>
	          ...
	          <td>
	          	<input style="width:250px;" name="startdate" id="startdate"
	        ...
	        <tr>
	          ...
	          <td bgcolor="#F1F4F9">
	          	<input style="width:250px;" name="enddate" id="enddate"
