...
<script type="text/javascript">
	...
	{ 
		...
		{ 
		 ...
		 obj.action = '${ctx}/school/importclazz!importcla.action?flag=import'; 
	     obj.submit(); 
	} 
...
<!--
   $(document).ready(function(){
         ...
         $("#test").click(function (){
     	    ...
     	    $("#uploadForm").attr("action","${ctx}/school/importclazz!test.action");             
            $("#uploadForm").submit();
...
<div class="mid1003_r">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      <td height="27" style="background: url('../images/login/tabbg01.jpg');" class="tbigtt">导入班级</td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="lin24"><strong>提示：</strong><br />
            ...
            4、<a href="${ctx }/attachment/download.action?name=班级模板.xls">模版下载</a>
			</div>
			</td>
        ...
        <tr>
		  ...
		  <div class="lin24"><strong>导入结果：</strong><br />
            ...
            2、成功${total-failnum}条信息；<span style="color:red;"><a href="${ctx }/school/importclazz!printSuccessInfo.action">点击下载成功信息</a></span> <br />
            3、失败${failnum}条信息；<span style="color:red;"><a href="${ctx }/school/importclazz!printErrorInfo.action">点击下载失败信息</a></span><br />
			</div></td>
          </tr>
      </table></td>
    </tr>
