...
<frameset rows="90,34,*,60" cols="*" frameborder="no" border="0"
	...
	<frameset rows="*" cols="26%,*" frameborder="no" border="0" framespacing="0" id="frame2"> 
        <frame name="nav" id="nav" scrolling="no" noresize src="common/infomenu.jsp" frameborder="0"></frame>
		<frame name="index" id="index" scrolling="auto" src="leave/leave!init.action"	frameborder="0"></frame>
	</frameset>
