...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/student/archivesinfo.action";
...
<div class="mid1003_l">
  <div id="my_menu" >
    <div class="leftlist_ico">档案信息</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../student/archivesinfo.action" target="index">档案信息</a></li>
        </ul>
      </div>
