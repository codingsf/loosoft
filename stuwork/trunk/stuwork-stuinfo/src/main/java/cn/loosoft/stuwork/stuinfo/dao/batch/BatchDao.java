...
package cn.loosoft.stuwork.stuinfo.dao.batch;
...
public class BatchDao extends HibernateDao<Batch, Long>
{
    ...
    private static final String SELECT_BATCHS      = "from Batch where current=true";

    private static final String SELECT_BATCHS_BYID = "from Batch where id=?";
