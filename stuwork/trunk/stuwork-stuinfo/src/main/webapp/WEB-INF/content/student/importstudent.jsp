...
<script type="text/javascript">
	...
	{ 
		...
		{ 
		  ...
		  obj.action = 'student/importstudent.action'; 
		  obj.submit(); 
		} 
	} 
	//]]>
...
<!--
   $(document).ready(function(){
         ...
         $("#test").click(function (){
     	    ...
     	    $("#uploadForm").attr("action","${ctx}/student/student!test.action");        
            $("#uploadForm").submit();
...
<div class="mid1003_r">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      <td height="27" style="background: url('../images/login/tabbg01.jpg');" class="tbigtt">导入基础信息</td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="lin24"><strong>提示：</strong><br />
            ...
            4、<a href="${ctx }/attachment/download.action?path=template&name=学生模版.xls">学生模版下载</a>
			</div>
	        </td>
