...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("#test").click(function (){
		    ...
		    $("#uploadForm").attr("action","${ctx}/student/student!testStuNo.action");        
	       $("#uploadForm").submit();
	...
	{ 
	  ...
	  { 
	   ...
	   return false; 
	     ...
	     obj.action = 'student/importstudentNo.action'; 
	     obj.submit(); 
	} 
	} 
	//]]>
...
<div class="mid1003_r">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      <td height="27" style="background: url('../images/login/tabbg01.jpg');" class="tbigtt">导入学号</td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="lin24"><strong>提示：</strong><br />
            ...
            4、<a href="${ctx }/attachment/download.action?path=template&name=学号模版.xls">学号模版下载</a>
			</div>
			</td>
        ...
        <tr>
		  ...
		  <div class="lin24"><strong>导入结果：</strong><br />
            ...
            3、失败${failnum}条信息；<span style="color:red;"><a href="${ctx }/student/student!printStuNoErrorInfo.action">点击下载失败信息</a></span><br/>
			</div></td>
          </tr>
      </table></td>
    </tr>
