	    ...
	    $(document).ready(function(){
			...
			$("#query").click(
				function(){
					...
					$("#queryForm").attr("action","${ctx }/batch/batch!list.action");
...
<form id="searchForm" action="${ctx}/batch/batch!list.action"
	method="post">
...
<div class="emb"></div>
<div class="mid1003_r">
<form action="${ctx}/batch/batch!deletes.action" method="post"
	id="deleteForm">
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<div class="tabhv">
		<ul>
			<li><a href="${ctx }/batch/batch-input.action">新增</a></li>
		</ul>
		</div>
		</td>
	</tr>
