...
<head>
	...
	<div class="header_mid01">
	  <div class="header_mid01l"><img src="../images/login/logo03.jpg" width="640" height="90" /></div>
	    ...
	    <table width="100%" style="height: 21px" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <td width="50%" class="dbyz">
				...
				${name}
				&nbsp;&nbsp;
				<a href="<common:prop name="cas.securityContext.logoutUrl" propfilename="application.properties"/>?from=<common:prop name="stuinfo.webapp.url" propfilename=""/>" target="_parent">注销</a>&nbsp;
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
		         <a href="<common:prop name="backmanage.webapp.url" propfilename=""/>" target="_parent">返回平台入口</a>
				</span>
			  <%}%>
	        </td>
	      </tr>
