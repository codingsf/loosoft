...
import cn.loosoft.stuwork.welnew.dao.log.BackLogDao;
...
// 默认将类中的所有函数纳入事务管理.
@Transactional
public class BackLogManager extends EntityManager<BackLog, Long>
{
    ...
    {
        return backLogDao.getBackLog(examineeNo, extendItemId);
    }

    @Override
    protected HibernateDao<BackLog, Long> getEntityDao()
    {
        return backLogDao;
    }
