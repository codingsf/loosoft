...
import cn.loosoft.stuwork.welnew.dao.sys.LogDataDao;
...
@Component
@Transactional
public class LogDataManager extends EntityManager<LogData, Long>
{
    @Autowired
    private LogDataDao logDataDao;

    @Override
    protected HibernateDao<LogData, Long> getEntityDao()
    {
        return logDataDao;
    }
