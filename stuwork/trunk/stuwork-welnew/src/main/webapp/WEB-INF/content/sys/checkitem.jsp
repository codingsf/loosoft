...
<div class="mid1003_r">
	<form action="${ctx}/sys/checkitem!deletes.action" method="post" id="deleteForm">
	...
	<tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');">
	      <div class="tabhv">
	        <ul>
			  <li><a href="checkitem!input.action"><span>新增</span></a></li>
    ...
    <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>审查项目设置</strong></td>
          </tr>
		  <tr>
		      <td width="1%" height="25" class="tbg03"><input type="checkbox" id="checkboxall" /></td>
	          <td width="16%" class="tbg03"><strong>审查项目名称</strong></td>
	          <td width="30%" class="tbg03"><strong>解决办法</strong></td>
	          <td width="30%" class="tbg03"><strong>描述</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>"><a href="${ctx}/sys/checkitem!input.action?id=${id}">修改</a></td>
