...
<div class="mid1003_r">
	<form action="${ctx}/sys/costitem!deletes.action" method="post" id="deleteForm">
	...
	<tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');">
	      <div class="tabhv">
	        <ul>
			  <li><a href="costitem!input.action"><span>新增</span></a></li>
    ...
    <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>缴费项目设置</strong></td>
          </tr>
		  <tr>
		      <td width="1%" height="25" class="tbg03"><input type="checkbox" id="checkboxall" /></td>
	          <td width="3%" class="tbg03"><strong>序号</strong></td>
	          <td width="19%" class="tbg03"><strong>缴费项目名称</strong></td>
	          <td width="19%" class="tbg03"><strong>费用单价</strong></td>
	          <td width="19%" class="tbg03"><strong>是否必须</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>"><a href="${ctx}/sys/costitem!input.action?id=${id}">修改</a></td>
