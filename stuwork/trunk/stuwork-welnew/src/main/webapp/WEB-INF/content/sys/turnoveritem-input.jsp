	...
	$(document).ready(function() {
		...
		$("#dataForm").validate({
			rules: {
			 name:{
			   required:true,
			   remote: "turnoveritem!checkName.action?oldName=" + encodeURIComponent('${name}')
			 },
			 description:{
				 maxlength:255
			 }
...
<div class="emb"></div>
<form action="${ctx}/sys/turnoveritem!save.action" method="post" id="dataForm">
...
<div class="mid1003_r">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #B4C8D3; border-right:1px solid #B4C8D3;">
    ...
    <tr>
      ...
      <s:if test="id == null">新增</s:if><s:else>修改</s:else>上缴项目(<span class="redz">*</span>为必填)
      </td>
    </tr>
    ...
    <tr>
      <td bgcolor="#FFFFFF">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="35%" height="30" align="right" class="tbg02 pr10">上缴项目名称<span class="STYLE1">*</span></td>
	          <td width="65%" >
