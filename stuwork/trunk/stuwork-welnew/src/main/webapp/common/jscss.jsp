...
<script type="text/javascript" src="${ctx }/js/formValidator.js"></script>
...
<link href="${ctx }/css/validator.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${ctx }/js/listoper.js" ></script>
