...
<form id="searchForm" action="${ctx}/batch/welbatch!list.action"
	method="post">
...
<div class="emb"></div>
<div class="mid1003_r">
<form action="${ctx}/batch/welbatch!deletes.action" method="post"
	id="deleteForm">
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<div class="tabhv">
		<ul>
			<li><a href="welbatch!input.action" >新增批次</a></li>
		</ul>
		</div>
		</td>
	</tr>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>"><a href="${ctx}/batch/welbatch!input.action?id=${obj.id}">修改</a>  </td>
		  </tr>
		  </s:iterator>
		</table> 
		</td>  
