...
<table class="tbhs" width="95%">
  ...
  <tr>
    <td>${student.name }</td>
    <td>${bankName }</td>
    <td><fmt:formatDate value="${recordTime}" type="date"
		pattern="yyyy-MM-dd" /></td>
    <td>${recordMoeny }</td>
    <td>${recordMark }</td>
    <td> <a href="${ctx}/query/remittance.action?id=${id}">处理</a></td>
  </tr>
</s:iterator>
</table>
</form>
...
<div>
<span class="btn">
   <a href="${ctx }/query/remittance!printExcel.action"><span>导出Excel</span></a>
</span>
</div>
</body>
</html>