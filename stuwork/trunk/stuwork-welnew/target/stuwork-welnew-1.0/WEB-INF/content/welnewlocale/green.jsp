	...
	<!--
	    $(document).ready(function(){
			...
			$("#submitDebt").click(function(){
				if(!confirm('您确定要办理费用缓交吗?')) return  false;
...
<div class="emb"></div>
<form id="searchForm" name="searchForm" action="${ctx}/welnewlocale/green!searchStudent.action" method="post">
<div class="mid1003_r">
    ...
    <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>绿色通道</strong></td>
          </tr>
		</table> 
...
<div class="mid1003_r">
    ...
    <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>缓交详情</strong></td>
          </tr>
		  <tr>
	          <td width="20%" class="tbg03" height="25"><strong>费用类别<span style="color: red;">（*为必缴项目）</span></strong></td>
	          <td width="12%" class="tbg03"><strong>费用标准(元)</strong></td>
	          <td width="12%" class="tbg03"><strong>已交金额(元)</strong></td>
	          <td width="12%" class="tbg03"><strong>缓交金额(元)</strong></td>
	          <td width="10%" class="tbg03"><strong>缓交时间</strong></td>          
		  </tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>"><input type="text"  name="payedMoneyFilter${status.index }" value="${payedMoney}" />&nbsp;</td>  		    
		    ...
		    <input name="debtDateFilter${status.index }"
				value="<s:date name="debtDate" format="yyyy-MM-dd" />"
				type="text" class="Wdate" class="ipt wid20 "  <c:if test="${money ne payedMoney }">onclick="WdatePicker()"</c:if> />
		    </td>   
    ...
    <tr>
       <td bgcolor="#FFFFFF">
       	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" height="30"  class="tbg02 pr10 br03">缓交原因</td>
            <td align="left" class="br03"><textarea id="remark" name="remark" cols="50" rows="5">${remark}</textarea></td>
          </tr>  
      	</table>
      </td>
    </tr>
	<tr>
      <td height="32" style="background: url('../images/login/tabbg02.jpg');"><table width="30%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
             <button type="button" id="submitDebt"  class="bulebu"<c:if test="${student eq null }">disabled="disabled"</c:if>>确认缓交</button>&nbsp;&nbsp;
		      <button type="reset"  class="bulebu">重置</button>
	      </td>
        </tr>
      </table></td>
    </tr>
