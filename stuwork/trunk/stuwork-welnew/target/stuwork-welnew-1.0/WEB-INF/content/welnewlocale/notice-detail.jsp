...
<div class="mid1003_r">
    ...
    <tr>
        ...
        <tr>
	          <td height="30" width="15%" align="right" class="tbg02 pr10">宿舍&nbsp;</td>
	          <td>
		       ${student.roombed }
	          </td>	 
	           <td height="30" width="15%" align="right"  class="tbg02 pr10">&nbsp;</td>
	          <td  width="35%"  bgcolor="#F1F4F9">
		      &nbsp;
	          </td>	                   
        </tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
		       <c:if test="${(money-payedMoney-debtMoney)>0}">
				   <span style="color: red;">${money-payedMoney-debtMoney}</span>
			   </c:if> 
			   <c:if test="${(money-payedMoney-debtMoney)<=0}">
                   ${money-payedMoney-debtMoney}
               </c:if>
		    </td> 
		  </tr>
		  </s:iterator>
