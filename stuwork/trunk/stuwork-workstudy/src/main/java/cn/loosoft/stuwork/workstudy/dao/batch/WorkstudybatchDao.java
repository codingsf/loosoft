...
package cn.loosoft.stuwork.workstudy.dao.batch;
 ...
 */
@Component
public class WorkstudybatchDao extends HibernateDao<Workstudybatch, Long>
{
    private static final String DELETE_SCHAREAS = "delete from Batch where id in(:ids)";

    private static final String DISABLED_BATCHS = "update Workstudybatch set current=?";
    ...
    {
        batchExecute(DISABLED_BATCHS, isCurrent);
    }
}
