...
import cn.loosoft.stuwork.workstudy.dao.job.StuDao;
...
public class StuManager extends EntityManager<StudentJobs, Long>
{
    ...
    {
        return stuDao.findByPostId(postId, pageNo);
    }
    ...
    {
        return stuDao.findCountByPostId(postId);
    }
    ...
    {
        return stuDao.findByPostIdAndStudentNO(postId, studentNo);
    }
