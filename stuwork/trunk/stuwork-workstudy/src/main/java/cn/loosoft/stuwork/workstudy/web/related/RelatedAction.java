...
//-------------------------------------------------------------------------
package cn.loosoft.stuwork.workstudy.web.related;
...
public class RelatedAction extends ActionSupport
{
    ...
    private WorkstudybatchManager workstudybatchManager;
    ...
    public String clazzList()
    {
        ...
        Workstudybatch workstudybatch = workstudybatchManager.getCurrentBatch();
        List<ClazzDTO> clazzDTOs = clazzWebService.getClazzsBySpecialty(
                majorCode, studentType, workstudybatch.getYear(),
                workstudybatch.getSeason());
    ...
    @Autowired
    public void setWorkstudybatchManager(
            WorkstudybatchManager workstudybatchManager)
    {
        this.workstudybatchManager = workstudybatchManager;
    }
