...
<div class="mid1003_r">
	...
	<tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');">
	      <div class="tabhv">
	        <ul>
	          	<li><a href="role!input.action" >新增</a></li>
    ...
    <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="9" bgcolor="#F7E582" class="br002"><strong>角色列表</strong></td>
          </tr>
		  <tr>
	          ...
	          <td width="10%" height="25" class="tbg03"><strong>名称</strong></td>
	          <td width="60%" class="tbg03"><strong>授权</strong></td>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
			   <a href="${ctx}/account/role!input.action?id=${obj.id }">修改</a> <a href="#" onclick="delOneRecord('${obj.id }','${ctx}/account/role!delete.action');">删除</a>
		    </td>
		  </tr>
		  </s:iterator>
		</table> 
