...
<div class="mid1003_r">
	...
	<tr>
      <td height="27"  style="background: url('../images/login/tabbg01.jpg');">
	      <div class="tabhv">
	        <ul>
			    <li><a href="${ctx}/file/upload!upload.action"><span>上传文件</span></a></li>
	        </ul>
	      </div>
      </td>
    </tr>
    
    <form id="searchForm" name="searchForm" action="../file/upload.action" method="post">
    ...
    <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
              <td height="30" colspan="8" bgcolor="#F7E582" class="br002"><strong>文件上传</strong></td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td class="<s:if test='#status.even'>br05</s:if><s:else>br03</s:else>">
			    <a href="#" onclick="delOneRecord('${id }','${ctx}/file/upload!delete.action');">删除</a>
		    </td>
