...
<form id="dataForm" name="dataForm" action="${ctx}/job/jobs-pub!save.action" method="post">
    ...
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="70%" >
             <textarea name="nopassreason" rows="4" cols="30" id="nopassreason">${nopassreason}</textarea>
          </td>
          </tr>
