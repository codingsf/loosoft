...
<form id="searchForm" action="${ctx}/query/jobs-query!list.action" method="post">
<div id="filter" class="fenye" style="display: none">
	<h3>
          ...
          发布时间:<input name="filter_EQD_pubdate" id="pubdate"
			value="${param['filter_EQD_pubdate']}" 
...
<table class="tbhs" width="95%">
	...
	<s:iterator value="page.result">
		<tr>
	        ...
	        <td>${exisitCount}&nbsp;</td>
			<td>
			 <a href="${ctx}/query/jobs-query!detail.action?id=${id}">查看</a>
			</td>
		</tr>
	</s:iterator>
</table>
