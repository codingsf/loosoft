...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/job/stucheck.action";
...
<div class="mid1003_l">
  <div id="my_menu" >
    <div class="leftlist_ico">申请审核</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../job/stucheck.action" target="index">学生申请审核</a></li>
        </ul>
      </div>
