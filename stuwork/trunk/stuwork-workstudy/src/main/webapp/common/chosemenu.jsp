...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/job/chose.action";
...
<div class="mid1003_l">
  <div id="my_menu" >
    <div class="leftlist_ico">用工选择</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../job/chose.action" target="index">用工选择</a></li>
        </ul>
      </div>
