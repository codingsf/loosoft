      ...
      <td bgcolor="#FFFFFF">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <tr>
	          ...
	          <td bgcolor="#F1F4F9">
	          	 <fmt:formatDate value="${entity.pubdate}" type="date"
					pattern="yyyy-MM-dd" />
	          </td>
	        </tr>
	        ...
	        <tr>
	          <td width="35%" height="30" align="right" class="tbg02 pr10">发布作者</td>
	          <td width="65%" >
	          	${entity.pubuser}
	          </td>
	        </tr>
	        ...
	        <tr>
	          <td width="35%" height="30" align="right" class="tbg02 pr10">内容</td>
	          <td width="65%" >
	          	${entity.content}
	          </td>
	        </tr>
