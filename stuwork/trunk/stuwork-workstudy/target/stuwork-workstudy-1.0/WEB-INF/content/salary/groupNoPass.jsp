...
<form id="dataForm" name="dataForm" action="${ctx}/salary/group-audit-salary!save.action" method="post">
    ...
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="70%" >
             <textarea name="groupNoPassReason" rows="4" cols="30" id="groupNoPassReason">${groupNoPassReason}</textarea>
          </td>
          </tr>
