...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/job/sturecheck.action";
...
<div class="mid1003_l">
  <div id="my_menu" >
    <div class="leftlist_ico">申请复审</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../job/sturecheck.action" target="index">申请复审</a></li>
        </ul>
      </div>
