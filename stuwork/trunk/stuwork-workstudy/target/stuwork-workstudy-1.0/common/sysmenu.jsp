...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			//设置右边内容
			window.parent.document.getElementById("index").src="${ctx}/sys/commitment.action";
...
<div class="mid1003_l">
  <div id="my_menu" >
    <div class="leftlist_ico">系统设置</div>
    <div class="listbox">
      <div id="menudiv" class="listw">
        <ul>
          <li><a class="listbgg" href="../sys/commitment.action" target="index">承诺书管理</a></li>
        </ul>
      </div>
