...
public class Jobs extends IdEntity
{
    ...
    public String getPostStatusDesc()
    {
        ...
        if (this.postStatus.equals(Constant.ZPTZ))
        {
            return "招聘停止";
        }
        return "";
    ...
    {
        if (this.auditStatus.equals("shz"))
        {
            return "审核中";
        }
        if (this.auditStatus.equals("shtg"))
        {
            return "审核通过";
        }
        if (this.auditStatus.equals("shwtg"))
        {
            return "审核未通过";
        }
        return "";
    ...
    public boolean isFull(){
    	return this.reqCount <= this.exisitCount;
    } 
}
