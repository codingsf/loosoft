...
<table class="tbhs1">
	...
	<tr>
		...
		<th>报名截止时间&nbsp;</th>
		<td><fmt:formatDate value="${entity.stopdate}" type="date"
			pattern="yyyy-MM-dd"></fmt:formatDate></td>
	</tr>
	<tr>
		<th>招聘人数&nbsp;</th>
	...
	<tr>
		<th>招聘状态&nbsp;</th>
		<td>${entity.postStatusDesc}</td>
		<th>审核状态&nbsp;</th>
		<td>${entity.auditStatusDesc}</td>
	</tr>
	<tr>
	</tr>
	<tr>
		<th>勤工要求&nbsp;</th>
		<td colspan="3">${entity.requireMents}</td>
	</tr>
	...
	<tr>
		<th>审核未过原因&nbsp;</th>
		<td colspan="3">${entity.nopassreason}</td>
	</tr>
	<tr>
		<td></td>
