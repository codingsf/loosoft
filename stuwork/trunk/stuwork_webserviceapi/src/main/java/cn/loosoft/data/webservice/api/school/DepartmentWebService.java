...
public interface DepartmentWebService
{
     ...
     * @return
     */
    List<DepartmentDTO> getDepartmentsByInstitute(@WebParam(name="code") String code);
     ...
     * @return
     */
    String getDepartmentName(@WebParam(name="code") String code);
     ...
     * @return
     */
    String getDepartmentCode(@WebParam(name="name") String name);
