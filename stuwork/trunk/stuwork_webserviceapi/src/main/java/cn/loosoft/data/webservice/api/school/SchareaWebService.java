 ...
 */
@WebService
public interface SchareaWebService
{
    /**
     * 
     * 取得所有学区
     ...
     * @return
     */
    String getSchareaName(@WebParam(name="code") String code);
     ...
     * @return
     */
    SchareaDTO getScharea(@WebParam(name="code") String code);
     ...
     * @return
     */
    String getCode(@WebParam(name="name") String name);
}
