	  ...
	  <div class="midbox">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<a href="/" class="lz">首页</a> &gt;<a href="/contact.aspx" class="lz">联系我们</a> &gt; 人才招聘</div>
			
			<div class="rbox01">
              <div class="rbox01_ico">
                <div class="sl">人才招聘 </div>
              </div>
			  <div class="rbox01_m">
			  <div class="zbu_bg">
			  ...
			  <%foreach (var item in Model)
                 { %>
			          <div class="zbu"><a href="/contact.aspx/jobinfo/<%=item.id %>"><%=item.name %></a></div>
		        <%} %>	  
		 
			  </div>
			  <div style=" clear:both;">
			    <p><strong>招聘说明</strong></p>
			    <p>1、  每个招聘职位备注中都注明了该职位的简历投递邮箱，请您将简历投递至该邮箱；</p>
			    <p>2、  如果您在三个工作日内未收到电话或短信初试通知，则表示您的简历未通过筛选，但简历会保留到公司人才库中；</p>
			    <p>3、  投递简历时，请在主题注明应聘职位。<br />
			      </p>
			  </div>
			  </div>
			</div>
