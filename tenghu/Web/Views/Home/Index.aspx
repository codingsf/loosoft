...
<body>
<% var images = ViewData["images"] as IList<DataLinq.Image>;
...
<div class="main">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<% foreach (DataLinq.Image img in images)
    { %>
          ...
          <tr>
            ...
            <td background="/img/body02.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<div class="ico01"><a href="/about.aspx/more/8"><img src="/img/ico01.jpg" width="259" height="18" border="0" /></a></div>
				<div class="nl01">
			    ...
			    <div><a href="/service.aspx?"><img src="/img/bu01.jpg" width="135" height="35" border="0" /></a><a href="/contact.aspx/job"><img src="/img/bu02.jpg" width="135" height="35" border="0" /></a></div></td>
                <td width="13"><img src="/img/line01.jpg" width="13" height="186" /></td>
                <td valign="top">
				<div class="ico01"><a href="/news.aspx"><img src="/img/ico02.jpg" width="349" height="18" border="0" /></a></div>
				<%if (news != null && news.Count > 0)
                { %>
				
				<div class="nl02">
				<div class="nl02_img"><a href="/news.aspx/info/<%=news[0].id %>"><img src="<%=news[0].imgUrl %>" width="79" height="46" border="0" /></a></div>
				<div class="nl02_r">
				<div><a href="/news.aspx/info/<%=news[0].id %>"><strong><%=news[0].title %></strong></a></div>
				...
				<% int i = 0;
				    foreach (var item in news)
                 {
                     if (i++.Equals(1))
                         continue;
                         %>
				<li><a href="/news.aspx/info/<%=item.id %>">·<%=item.title %></a></li>
		        <%} %>
				</ul>
				</div>
                ...
                <td width="13"><img src="/img/line01.jpg" width="13" height="186" /></td>
                <td width="250"><a href="/patent.aspx/info"><img src="/img/video.jpg" width="248" height="160" border="0" /></a></td>
              </tr>
            </table></td>
