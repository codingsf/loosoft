	  ...
	  <div class="midbox">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<div class="ny_wz"><span class="f11">Welcome to</span> <span class="bulez f11">PROUDTIGER</span> > <a href="/home" class="lz">首页</a>  > <a href="/product.aspx" class="lz">产品展示</a> >  <%=(ViewData["info"] as Category).name %></div>
			<div>
