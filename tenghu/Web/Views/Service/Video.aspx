...
<head runat="server">
    ...
    function changePage(index) {
        window.location.href = "/service/video/?page=" + index;
    }   
...
<div class="main">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <div class="ny_banner"><img src="/img/banner/banner_23.jpg" width="964" height="147" /></div>
	  <div class="midbox">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                        ...
                        i++;
                          ...
                          %>
                               ...
                               <td width="25%" align="center"><div>
                                   <div><a href="/service.aspx/videoinfo/<%=video.id %>"><img src="/video/file/<%=video.pic %>" width="136" height="83" class="video01" /></a></div>
                                 <div class="video02"><a href="/service.aspx/videoinfo/<%=video.id %>"><%=video.name %></a></div>
                               </div></td>
