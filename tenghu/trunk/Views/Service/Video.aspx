                        ...
                        i++;
                          ...
                          %>
                               ...
                               <td width="25%" align="center"><div>
                                   <div><a href="/service/videoinfo/<%=video.id %>"><img src="/video/file/<%=video.pic %>" width="136" height="83" class="video01" /></a></div>
                                 <div class="video02"><a href="/service/videoinfo/<%=video.id %>"><%=video.name %></a></div>
                               </div></td>
